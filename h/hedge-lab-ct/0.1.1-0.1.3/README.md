# Comparing `tmp/hedge_lab_ct-0.1.1.tar.gz` & `tmp/hedge_lab_ct-0.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hedge_lab_ct-0.1.1.tar", last modified: Wed May  8 02:47:02 2024, max compression
+gzip compressed data, was "hedge_lab_ct-0.1.3.tar", last modified: Wed May  8 15:57:42 2024, max compression
```

## Comparing `hedge_lab_ct-0.1.1.tar` & `hedge_lab_ct-0.1.3.tar`

### file list

```diff
@@ -1,32 +1,49 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 02:47:02.589154 hedge_lab_ct-0.1.1/
--rw-r--r--   0 runner    (1001) docker     (127)    11324 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)      126 2024-05-08 02:47:02.589154 hedge_lab_ct-0.1.1/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)        6 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 02:47:02.589154 hedge_lab_ct-0.1.1/cv-lab-aurct/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     1456 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/detector.py
--rw-r--r--   0 runner    (1001) docker     (127)      117 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex1.py
--rw-r--r--   0 runner    (1001) docker     (127)     1418 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex10.py
--rw-r--r--   0 runner    (1001) docker     (127)      164 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex2a.py
--rw-r--r--   0 runner    (1001) docker     (127)      183 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex2b.py
--rw-r--r--   0 runner    (1001) docker     (127)      685 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex2c.py
--rw-r--r--   0 runner    (1001) docker     (127)      421 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex3.py
--rw-r--r--   0 runner    (1001) docker     (127)     1201 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex4.py
--rw-r--r--   0 runner    (1001) docker     (127)      442 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex5a.py
--rw-r--r--   0 runner    (1001) docker     (127)      354 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex5b.py
--rw-r--r--   0 runner    (1001) docker     (127)     1186 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex5c.py
--rw-r--r--   0 runner    (1001) docker     (127)      459 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex6.py
--rw-r--r--   0 runner    (1001) docker     (127)     1632 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex7.py
--rw-r--r--   0 runner    (1001) docker     (127)      137 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex8.py
--rw-r--r--   0 runner    (1001) docker     (127)     1313 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex81.py
--rw-r--r--   0 runner    (1001) docker     (127)      305 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/ex9.py
--rw-r--r--   0 runner    (1001) docker     (127)     3157 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/kalman.py
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/main.py
--rw-r--r--   0 runner    (1001) docker     (127)     1221 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/cv-lab-aurct/tracker.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 02:47:02.589154 hedge_lab_ct-0.1.1/hedge_lab_ct.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)      126 2024-05-08 02:47:02.000000 hedge_lab_ct-0.1.1/hedge_lab_ct.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      596 2024-05-08 02:47:02.000000 hedge_lab_ct-0.1.1/hedge_lab_ct.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-08 02:47:02.000000 hedge_lab_ct-0.1.1/hedge_lab_ct.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       13 2024-05-08 02:47:02.000000 hedge_lab_ct-0.1.1/hedge_lab_ct.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-08 02:47:02.589154 hedge_lab_ct-0.1.1/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      264 2024-05-08 02:46:58.000000 hedge_lab_ct-0.1.1/setup.py
...
### Comparing `hedge_lab_ct-0.1.1/LICENSE` & `hedge_lab_ct-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/detector.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/detector.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/ex10.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/ex10.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/ex2c.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/ex2c.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/ex4.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/ex4.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/ex5c.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/ex5c.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/ex7.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/ex7.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/ex81.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/ex81.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/kalman.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/kalman.py`

 * *Files identical despite different names*

### Comparing `hedge_lab_ct-0.1.1/cv-lab-aurct/tracker.py` & `hedge_lab_ct-0.1.3/cv-lab-aurct/tracker.py`
