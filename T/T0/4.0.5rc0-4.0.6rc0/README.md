# Comparing `tmp/t0-4.0.5rc0.tar.gz` & `tmp/t0-4.0.6rc0.tar.gz`
...
### Comparing `t0-4.0.5rc0/LICENSE` & `t0-4.0.6rc0/LICENSE`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/NOTICE` & `t0-4.0.6rc0/NOTICE`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/00_deploy.sh` & `t0-4.0.6rc0/bin/00_deploy.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/00_deploy_prod.sh` & `t0-4.0.6rc0/bin/00_deploy_prod.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/00_deploy_replay.sh` & `t0-4.0.6rc0/bin/00_deploy_replay.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/00_patches.sh` & `t0-4.0.6rc0/bin/00_patches.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/00_software.sh` & `t0-4.0.6rc0/bin/00_software.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/buildrelease.sh` & `t0-4.0.6rc0/bin/buildrelease.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/cmst0_backlog_wma` & `t0-4.0.6rc0/bin/cmst0_backlog_wma`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/cmst0_late_workflows` & `t0-4.0.6rc0/bin/cmst0_late_workflows`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/cmst0_long_jobs` & `t0-4.0.6rc0/bin/cmst0_long_jobs`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/cmst0_paused_jobs` & `t0-4.0.6rc0/bin/cmst0_paused_jobs`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/diagnoseActiveRuns` & `t0-4.0.6rc0/bin/diagnoseActiveRuns`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/forceCloseRuns` & `t0-4.0.6rc0/bin/forceCloseRuns`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/bin/tier0-mod-config` & `t0-4.0.6rc0/bin/tier0-mod-config`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/ContainterConfig.sh` & `t0-4.0.6rc0/etc/ContainterConfig.sh`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/HIProdOfflineConfiguration.py` & `t0-4.0.6rc0/etc/HIProdOfflineConfiguration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/HIReplayOfflineConfiguration.py` & `t0-4.0.6rc0/etc/HIReplayOfflineConfiguration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/ProdOfflineConfiguration.py` & `t0-4.0.6rc0/etc/ProdOfflineConfiguration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/ReplayOfflineConfiguration.py` & `t0-4.0.6rc0/etc/ReplayOfflineConfiguration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/ReplayOfflineConfigurationRun1.py` & `t0-4.0.6rc0/etc/ReplayOfflineConfigurationRun1.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/SLSAlarmsConfig.py` & `t0-4.0.6rc0/etc/SLSAlarmsConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/Tier0Config.py` & `t0-4.0.6rc0/etc/Tier0Config.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/XeXeProdOfflineConfiguration.py` & `t0-4.0.6rc0/etc/XeXeProdOfflineConfiguration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/etc/XeXeReplayOfflineConfiguration.py` & `t0-4.0.6rc0/etc/XeXeReplayOfflineConfiguration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/ConditionUpload/ConditionUploadAPI.py` & `t0-4.0.6rc0/src/python/T0/ConditionUpload/ConditionUploadAPI.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/ConditionUpload/upload.py` & `t0-4.0.6rc0/src/python/T0/ConditionUpload/upload.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/JobSplitting/AlcaHarvest.py` & `t0-4.0.6rc0/src/python/T0/JobSplitting/AlcaHarvest.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/JobSplitting/Condition.py` & `t0-4.0.6rc0/src/python/T0/JobSplitting/Condition.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/JobSplitting/Express.py` & `t0-4.0.6rc0/src/python/T0/JobSplitting/Express.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/JobSplitting/ExpressMerge.py` & `t0-4.0.6rc0/src/python/T0/JobSplitting/ExpressMerge.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/JobSplitting/Repack.py` & `t0-4.0.6rc0/src/python/T0/JobSplitting/Repack.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/JobSplitting/RepackMerge.py` & `t0-4.0.6rc0/src/python/T0/JobSplitting/RepackMerge.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/RunConfig/RunConfigAPI.py` & `t0-4.0.6rc0/src/python/T0/RunConfig/RunConfigAPI.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/RunConfig/Tier0Config.py` & `t0-4.0.6rc0/src/python/T0/RunConfig/Tier0Config.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/RunLumiCloseout/RunLumiCloseoutAPI.py` & `t0-4.0.6rc0/src/python/T0/RunLumiCloseout/RunLumiCloseoutAPI.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/StorageManager/StorageManagerAPI.py` & `t0-4.0.6rc0/src/python/T0/StorageManager/StorageManagerAPI.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/ConditionUpload/CompleteFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/ConditionUpload/CompleteFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/ConditionUpload/FinishPCLforEmptyExpress.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/ConditionUpload/FinishPCLforEmptyExpress.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/ConditionUpload/GetConditions.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/ConditionUpload/GetConditions.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/ConditionUpload/GetRunStopTime.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/ConditionUpload/GetRunStopTime.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/ConditionUpload/IsPromptCalibrationFinished.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/ConditionUpload/IsPromptCalibrationFinished.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/ConditionUpload/MarkPromptCalibrationFinished.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/ConditionUpload/MarkPromptCalibrationFinished.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Create.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Create.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/JobSplitting/InsertPromptCalibrationFile.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/JobSplitting/InsertPromptCalibrationFile.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/JobSplitting/InsertSplitLumis.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/JobSplitting/InsertSplitLumis.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/FindRecoRelease.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/FindRecoRelease.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/FindRecoReleaseDatasets.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/FindRecoReleaseDatasets.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetExpressConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetExpressConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetHLTConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetHLTConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetPhEDExConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetPhEDExConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetRecoConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetRecoConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetRepackConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetRepackConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetRunInfo.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetRunInfo.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamDatasetTriggers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamDatasetTriggers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamDatasets.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamDatasets.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamOnlineVersion.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamOnlineVersion.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamStyle.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/GetStreamStyle.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertCMSSWVersion.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertCMSSWVersion.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertDatasetScenario.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertDatasetScenario.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertDatasetTrigger.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertDatasetTrigger.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertExpressConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertExpressConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertLumiSection.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertLumiSection.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertPhEDExConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertPhEDExConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertPrimaryDataset.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertPrimaryDataset.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertPromptCalibration.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertPromptCalibration.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRecoConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRecoConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRecoReleaseConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRecoReleaseConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRepackConfig.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRepackConfig.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRun.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRun.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRunStreamDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertRunStreamDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertSpecialDataset.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertSpecialDataset.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStorageNode.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStorageNode.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStream.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStream.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamCMSSWVersion.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamCMSSWVersion.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamDataset.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamDataset.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamFileset.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamFileset.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamStyle.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamStyle.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamer.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertStreamer.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertTrigger.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertTrigger.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertWorkflowMonitoring.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/InsertWorkflowMonitoring.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/ReleasePromptReco.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/ReleasePromptReco.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunConfig/UpdateRun.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunConfig/UpdateRun.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CheckActiveSplitLumis.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CheckActiveSplitLumis.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CheckClosedLumis.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CheckClosedLumis.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CheckEndOfRunRecords.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CheckEndOfRunRecords.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CloseRunStreamFilesets.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CloseRunStreamFilesets.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CloseRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/CloseRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/DeleteStreamers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/DeleteStreamers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FinalCloseLumi.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FinalCloseLumi.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindActiveRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindActiveRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindClosedLumis.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindClosedLumis.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindClosedRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindClosedRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindHighContLumi.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindHighContLumi.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindOpenRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindOpenRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindStoppedRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/FindStoppedRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/ForceCloseLumi.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/ForceCloseLumi.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetClosedLumisForStream.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetClosedLumisForStream.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetFileCountOnOpenLumis.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetFileCountOnOpenLumis.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetFilesForStreamLumi.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetFilesForStreamLumi.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetOpenRunStreamLumicount.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/GetOpenRunStreamLumicount.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/InsertClosedLumi.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/InsertClosedLumi.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/StopRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/RunLumiCloseout/StopRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/SMNotification/GetFinishedStreamers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/SMNotification/GetFinishedStreamers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/SMNotification/InsertOfflineFileStatus.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/SMNotification/InsertOfflineFileStatus.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/SMNotification/MarkStreamersFinished.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/SMNotification/MarkStreamersFinished.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/SMNotification/UpdateOfflineFileStatus.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/SMNotification/UpdateOfflineFileStatus.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/StorageManager/GetNewData.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/StorageManager/GetNewData.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/StorageManager/GetRunInfo.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/StorageManager/GetRunInfo.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/StorageManager/GetRunSetup.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/StorageManager/GetRunSetup.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAllFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAllFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableConditionFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableConditionFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableExpressFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableExpressFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableExpressMergeFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableExpressMergeFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableRepackFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableRepackFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableRepackMergeFiles.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetAvailableRepackMergeFiles.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetLumiHolesForRepack.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetLumiHolesForRepack.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetLumiHolesForRepackMerge.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetLumiHolesForRepackMerge.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetUsedLumis.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/GetUsedLumis.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/HaveAvailableFile.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/HaveAvailableFile.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Subscriptions/HaveJobGroup.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Subscriptions/HaveJobGroup.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetDatasetLocked.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetDatasetLocked.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetExpressConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetExpressConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetNewRun.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetNewRun.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetPromptRecoStatus.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetPromptRecoStatus.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetRecoConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetRecoConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetRunStreamDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetRunStreamDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetSkippedStreamers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/GetSkippedStreamers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertDatasetLocked.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertDatasetLocked.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertExpressConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertExpressConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertNewRun.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertNewRun.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRecoConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRecoConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRecoLocked.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRecoLocked.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRunDatasetDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRunDatasetDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRunStreamDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertRunStreamDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertSkippedStreamers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/InsertSkippedStreamers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateDatasetLocked.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateDatasetLocked.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateExpressConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateExpressConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateNewRun.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateNewRun.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRecoConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRecoConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRecoLocked.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRecoLocked.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRunDatasetDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRunDatasetDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRunStreamDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateRunStreamDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateSkippedStreamers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/T0DataSvc/UpdateSkippedStreamers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FeedStreamers.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FeedStreamers.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FindNewExpressRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FindNewExpressRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FindNewRunStreams.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FindNewRunStreams.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FindNewRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/FindNewRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetDeploymentID.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetDeploymentID.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetExpressReadyRuns.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetExpressReadyRuns.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetNotClosedOutWorkflows.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetNotClosedOutWorkflows.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetPromptRecoWorkflowsForMonitoring.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetPromptRecoWorkflowsForMonitoring.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetRunDatasetDone.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetRunDatasetDone.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetRunDatasetNew.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetRunDatasetNew.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetRunDatasetReleased.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetRunDatasetReleased.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetStreamerWorkflowsForMonitoring.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/GetStreamerWorkflowsForMonitoring.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/MarkCloseoutWorkflowMonitoring.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/MarkCloseoutWorkflowMonitoring.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/MarkTrackedWorkflowMonitoring.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/MarkTrackedWorkflowMonitoring.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/MarkWorkflowsInjected.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/MarkWorkflowsInjected.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/ReleaseExpress.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/ReleaseExpress.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/SetDeploymentID.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/SetDeploymentID.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/UpdateRecoReleaseConfigs.py` & `t0-4.0.6rc0/src/python/T0/WMBS/Oracle/Tier0Feeder/UpdateRecoReleaseConfigs.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0.egg-info/SOURCES.txt` & `t0-4.0.6rc0/src/python/T0.egg-info/SOURCES.txt`
...
-doc/sphinx/code/T0/JobSplitting.rst
-doc/sphinx/code/T0/RunConfig.rst
-doc/sphinx/code/T0/WMBS.rst
-doc/sphinx/code/T0/WMSpecs.rst
-doc/sphinx/code/T0Component/Tier0Feeder.rst
...
-src/python/T0.egg-info/requires.txt
 ...
 src/python/T0/ConditionUpload/upload.py
 src/python/T0/JobSplitting/AlcaHarvest.py
 src/python/T0/JobSplitting/Condition.py
 src/python/T0/JobSplitting/Express.py
@@ -209,18 +189,8 @@
...
-test/python/T0Component_t/Tier0Feeder_t/ExampleConfig.py
-test/python/T0Component_t/Tier0Feeder_t/Tier0Feeder_t.py
-test/python/T0_t/RunConfig_t/Tier0Config_t.py
-test/python/T0_t/WMBS_t/JobSplitting_t/Condition_t.py
-test/python/T0_t/WMBS_t/JobSplitting_t/ExpressMerge_t.py
-test/python/T0_t/WMBS_t/JobSplitting_t/Express_t.py
-test/python/T0_t/WMBS_t/JobSplitting_t/RepackMerge_t.py
-test/python/T0_t/WMBS_t/JobSplitting_t/Repack_t.py
-test/python/T0_t/WMBS_t/RunConfig_t/ExampleConfig.py
-test/python/T0_t/WMBS_t/RunConfig_t/RunConfig_t.py
+src/python/T0Component/Tier0Feeder/__init__.py
```

### Comparing `t0-4.0.5rc0/src/python/T0Component/Tier0Auditor/Tier0Auditor.py` & `t0-4.0.6rc0/src/python/T0Component/Tier0Auditor/Tier0Auditor.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0Component/Tier0Auditor/Tier0AuditorPoller.py` & `t0-4.0.6rc0/src/python/T0Component/Tier0Auditor/Tier0AuditorPoller.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0Component/Tier0Feeder/Tier0Feeder.py` & `t0-4.0.6rc0/src/python/T0Component/Tier0Feeder/Tier0Feeder.py`

 * *Files identical despite different names*

### Comparing `t0-4.0.5rc0/src/python/T0Component/Tier0Feeder/Tier0FeederPoller.py` & `t0-4.0.6rc0/src/python/T0Component/Tier0Feeder/Tier0FeederPoller.py`
