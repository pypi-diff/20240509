# Comparing `tmp/baddns-1.1.781.tar.gz` & `tmp/baddns-1.1.784.tar.gz`
...
## Comparing `baddns-1.1.781.tar` & `baddns-1.1.784.tar`
...
### Comparing `baddns-1.1.781/LICENSE` & `baddns-1.1.784/LICENSE`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/README.md` & `baddns-1.1.784/README.md`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/__init__.py` & `baddns-1.1.784/baddns/__init__.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/base.py` & `baddns-1.1.784/baddns/base.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/cli.py` & `baddns-1.1.784/baddns/cli.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/dnsmanager.py` & `baddns-1.1.784/baddns/lib/dnsmanager.py`
...
### Comparing `baddns-1.1.781/baddns/lib/dnswalk.py` & `baddns-1.1.784/baddns/lib/dnswalk.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/findings.py` & `baddns-1.1.784/baddns/lib/findings.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/httpmanager.py` & `baddns-1.1.784/baddns/lib/httpmanager.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/loader.py` & `baddns-1.1.784/baddns/lib/loader.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/logging.py` & `baddns-1.1.784/baddns/lib/logging.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/matcher.py` & `baddns-1.1.784/baddns/lib/matcher.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/signature.py` & `baddns-1.1.784/baddns/lib/signature.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/lib/whoismanager.py` & `baddns-1.1.784/baddns/lib/whoismanager.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/cname.py` & `baddns-1.1.784/baddns/modules/cname.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/mx.py` & `baddns-1.1.784/baddns/modules/mx.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/ns.py` & `baddns-1.1.784/baddns/modules/ns.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/nsec.py` & `baddns-1.1.784/baddns/modules/nsec.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/references.py` & `baddns-1.1.784/baddns/modules/references.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/txt.py` & `baddns-1.1.784/baddns/modules/txt.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/modules/zonetransfer.py` & `baddns-1.1.784/baddns/modules/zonetransfer.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/scripts/readsources.py` & `baddns-1.1.784/baddns/scripts/readsources.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/scripts/signaturetest.py` & `baddns-1.1.784/baddns/scripts/signaturetest.py`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/signatures/dnsreaper_elastic_beanstalk.yml` & `baddns-1.1.784/baddns/signatures/dnsreaper_elastic_beanstalk.yml`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/signatures/nucleitemplates_azure-takeover-detection.yml` & `baddns-1.1.784/baddns/signatures/nucleitemplates_azure-takeover-detection.yml`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/signatures/nucleitemplates_flywheel-takeover.yml` & `baddns-1.1.784/baddns/signatures/nucleitemplates_flywheel-takeover.yml`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/signatures/nucleitemplates_shopify-takeover.yml` & `baddns-1.1.784/baddns/signatures/nucleitemplates_shopify-takeover.yml`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/signatures/nucleitemplates_sprintful-takeover.yml` & `baddns-1.1.784/baddns/signatures/nucleitemplates_sprintful-takeover.yml`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/baddns/signatures/signature_history.txt` & `baddns-1.1.784/baddns/signatures/signature_history.txt`

 * *Files identical despite different names*

### Comparing `baddns-1.1.781/pyproject.toml` & `baddns-1.1.784/pyproject.toml`
...
### Comparing `baddns-1.1.781/PKG-INFO` & `baddns-1.1.784/PKG-INFO`
