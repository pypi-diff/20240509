# Comparing `tmp/anabih_python_test-3.0.0.tar.gz` & `tmp/anabih_python_test-4.0.0.tar.gz`
...
## Comparing `anabih_python_test-3.0.0.tar` & `anabih_python_test-4.0.0.tar`
...
### Comparing `anabih_python_test-3.0.0/setup.py` & `anabih_python_test-4.0.0/setup.py`
