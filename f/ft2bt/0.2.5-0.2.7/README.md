# Comparing `tmp/ft2bt-0.2.5.tar.gz` & `tmp/ft2bt-0.2.7.tar.gz`
...
### Comparing `ft2bt-0.2.5/README.md` & `ft2bt-0.2.7/README.md`
...
### Comparing `ft2bt-0.2.5/ft2bt.egg-info/SOURCES.txt` & `ft2bt-0.2.7/ft2bt.egg-info/SOURCES.txt`
