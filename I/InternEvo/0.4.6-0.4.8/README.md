# Comparing `tmp/InternEvo-0.4.6.tar.gz` & `tmp/InternEvo-0.4.8.tar.gz`
...
## Comparing `InternEvo-0.4.6.tar` & `InternEvo-0.4.8.tar`
...
### Comparing `InternEvo-0.4.6/InternEvo.egg-info/PKG-INFO` & `InternEvo-0.4.8/InternEvo.egg-info/PKG-INFO`
...
### Comparing `InternEvo-0.4.6/InternEvo.egg-info/SOURCES.txt` & `InternEvo-0.4.8/InternEvo.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/LICENSE` & `InternEvo-0.4.8/LICENSE`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/PKG-INFO` & `InternEvo-0.4.8/PKG-INFO`
...
### Comparing `InternEvo-0.4.6/README.md` & `InternEvo-0.4.8/README.md`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/accelerator/abstract_accelerator.py` & `InternEvo-0.4.8/internlm/accelerator/abstract_accelerator.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/accelerator/cuda_accelerator.py` & `InternEvo-0.4.8/internlm/accelerator/cuda_accelerator.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/accelerator/dipu_accelerator.py` & `InternEvo-0.4.8/internlm/accelerator/dipu_accelerator.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/accelerator/npu_accelerator.py` & `InternEvo-0.4.8/internlm/accelerator/npu_accelerator.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/apis/inference.py` & `InternEvo-0.4.8/internlm/apis/inference.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/checkpoint/checkpoint_manager.py` & `InternEvo-0.4.8/internlm/checkpoint/checkpoint_manager.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/checkpoint/components.py` & `InternEvo-0.4.8/internlm/checkpoint/components.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/checkpoint/load_funcs.py` & `InternEvo-0.4.8/internlm/checkpoint/load_funcs.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/checkpoint/utils.py` & `InternEvo-0.4.8/internlm/checkpoint/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/communication/__init__.py` & `InternEvo-0.4.8/internlm/core/communication/__init__.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/communication/isp.py` & `InternEvo-0.4.8/internlm/core/communication/isp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/communication/p2p.py` & `InternEvo-0.4.8/internlm/core/communication/p2p.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/communication/utils.py` & `InternEvo-0.4.8/internlm/core/communication/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/context/__init__.py` & `InternEvo-0.4.8/internlm/core/context/__init__.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/context/parallel_context.py` & `InternEvo-0.4.8/internlm/core/context/parallel_context.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/context/process_group_initializer.py` & `InternEvo-0.4.8/internlm/core/context/process_group_initializer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/context/random.py` & `InternEvo-0.4.8/internlm/core/context/random.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/engine.py` & `InternEvo-0.4.8/internlm/core/engine.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/gradient_handler.py` & `InternEvo-0.4.8/internlm/core/gradient_handler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/naive_amp.py` & `InternEvo-0.4.8/internlm/core/naive_amp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/scheduler/base_scheduler.py` & `InternEvo-0.4.8/internlm/core/scheduler/base_scheduler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/scheduler/no_pipeline_scheduler.py` & `InternEvo-0.4.8/internlm/core/scheduler/no_pipeline_scheduler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/scheduler/pipeline_scheduler.py` & `InternEvo-0.4.8/internlm/core/scheduler/pipeline_scheduler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/core/trainer.py` & `InternEvo-0.4.8/internlm/core/trainer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/build_dataloader.py` & `InternEvo-0.4.8/internlm/data/build_dataloader.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/batch_sampler.py` & `InternEvo-0.4.8/internlm/data/tokenized/batch_sampler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/collaters.py` & `InternEvo-0.4.8/internlm/data/tokenized/collaters.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/dataset.py` & `InternEvo-0.4.8/internlm/data/tokenized/dataset.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/dummy_dataset.py` & `InternEvo-0.4.8/internlm/data/tokenized/dummy_dataset.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/dummy_dataset_multimodal.py` & `InternEvo-0.4.8/internlm/data/tokenized/dummy_dataset_multimodal.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/packed_dataset.py` & `InternEvo-0.4.8/internlm/data/tokenized/packed_dataset.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/tokenized/single_dataset.py` & `InternEvo-0.4.8/internlm/data/tokenized/single_dataset.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/data/utils.py` & `InternEvo-0.4.8/internlm/data/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/eval/evaluation.py` & `InternEvo-0.4.8/internlm/eval/evaluation.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/initialize/initialize_tensor.py` & `InternEvo-0.4.8/internlm/initialize/initialize_tensor.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/initialize/initialize_trainer.py` & `InternEvo-0.4.8/internlm/initialize/initialize_trainer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/initialize/launch.py` & `InternEvo-0.4.8/internlm/initialize/launch.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/initialize/legacy/launch.py` & `InternEvo-0.4.8/internlm/initialize/legacy/launch.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/__init__.py` & `InternEvo-0.4.8/internlm/model/__init__.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/llava_modules/clip_encoder.py` & `InternEvo-0.4.8/internlm/model/llava_modules/clip_encoder.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/llava_modules/projector_builder.py` & `InternEvo-0.4.8/internlm/model/llava_modules/projector_builder.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/losses/ce_loss.py` & `InternEvo-0.4.8/internlm/model/losses/ce_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/metrics.py` & `InternEvo-0.4.8/internlm/model/metrics.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modeling_internlm.py` & `InternEvo-0.4.8/internlm/model/modeling_internlm.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modeling_internlm2.py` & `InternEvo-0.4.8/internlm/model/modeling_internlm2.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modeling_llama.py` & `InternEvo-0.4.8/internlm/model/modeling_llama.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modeling_llava.py` & `InternEvo-0.4.8/internlm/model/modeling_llava.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modeling_moe.py` & `InternEvo-0.4.8/internlm/model/modeling_moe.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modules/embedding.py` & `InternEvo-0.4.8/internlm/model/modules/embedding.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modules/mlp.py` & `InternEvo-0.4.8/internlm/model/modules/mlp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/modules/multi_head_attention.py` & `InternEvo-0.4.8/internlm/model/modules/multi_head_attention.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/__init__.py` & `InternEvo-0.4.8/internlm/model/moe/__init__.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/base_layer.py` & `InternEvo-0.4.8/internlm/model/moe/base_layer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/experts.py` & `InternEvo-0.4.8/internlm/model/moe/experts.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/gshard_layer.py` & `InternEvo-0.4.8/internlm/model/moe/gshard_layer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/megablock/megablock_dmoe.py` & `InternEvo-0.4.8/internlm/model/moe/megablock/megablock_dmoe.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/megablock/megablock_moe.py` & `InternEvo-0.4.8/internlm/model/moe/megablock/megablock_moe.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/megablock/mlp.py` & `InternEvo-0.4.8/internlm/model/moe/megablock/mlp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/megablock/utils.py` & `InternEvo-0.4.8/internlm/model/moe/megablock/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/moe.py` & `InternEvo-0.4.8/internlm/model/moe/moe.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/moe/utils.py` & `InternEvo-0.4.8/internlm/model/moe/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/ops/fusion_ops_import_helper.py` & `InternEvo-0.4.8/internlm/model/ops/fusion_ops_import_helper.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/ops/linear.py` & `InternEvo-0.4.8/internlm/model/ops/linear.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/ops/norm.py` & `InternEvo-0.4.8/internlm/model/ops/norm.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/model/utils.py` & `InternEvo-0.4.8/internlm/model/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/monitor/alert.py` & `InternEvo-0.4.8/internlm/monitor/alert.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/monitor/monitor.py` & `InternEvo-0.4.8/internlm/monitor/monitor.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/monitor/utils.py` & `InternEvo-0.4.8/internlm/monitor/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/activation_checkpoint.py` & `InternEvo-0.4.8/internlm/solver/activation_checkpoint.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/optimizer/base_optimizer.py` & `InternEvo-0.4.8/internlm/solver/optimizer/base_optimizer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/optimizer/fsdp_optimizer.py` & `InternEvo-0.4.8/internlm/solver/optimizer/fsdp_optimizer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/optimizer/hybrid_zero_optim.py` & `InternEvo-0.4.8/internlm/solver/optimizer/hybrid_zero_optim.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/optimizer/store.py` & `InternEvo-0.4.8/internlm/solver/optimizer/store.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/optimizer/utils.py` & `InternEvo-0.4.8/internlm/solver/optimizer/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/pipeline_utils.py` & `InternEvo-0.4.8/internlm/solver/pipeline_utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/schedulers/beta2_scheduler.py` & `InternEvo-0.4.8/internlm/solver/schedulers/beta2_scheduler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/solver/schedulers/lr_scheduler.py` & `InternEvo-0.4.8/internlm/solver/schedulers/lr_scheduler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/train/__init__.py` & `InternEvo-0.4.8/internlm/train/__init__.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/train/pipeline.py` & `InternEvo-0.4.8/internlm/train/pipeline.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/train/utils.py` & `InternEvo-0.4.8/internlm/train/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/common.py` & `InternEvo-0.4.8/internlm/utils/common.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/gputest.py` & `InternEvo-0.4.8/internlm/utils/gputest.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/logger.py` & `InternEvo-0.4.8/internlm/utils/logger.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/megatron_timers.py` & `InternEvo-0.4.8/internlm/utils/megatron_timers.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/parallel.py` & `InternEvo-0.4.8/internlm/utils/parallel.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/registry.py` & `InternEvo-0.4.8/internlm/utils/registry.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/simple_memory_profiler.py` & `InternEvo-0.4.8/internlm/utils/simple_memory_profiler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/storage_manager.py` & `InternEvo-0.4.8/internlm/utils/storage_manager.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/timeout.py` & `InternEvo-0.4.8/internlm/utils/timeout.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/utils.py` & `InternEvo-0.4.8/internlm/utils/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/internlm/utils/writer.py` & `InternEvo-0.4.8/internlm/utils/writer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/setup.py` & `InternEvo-0.4.8/setup.py`
...
### Comparing `InternEvo-0.4.6/tests/common_fixture.py` & `InternEvo-0.4.8/tests/common_fixture.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_core/test_pipeline.py` & `InternEvo-0.4.8/tests/test_core/test_pipeline.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_core/utils.py` & `InternEvo-0.4.8/tests/test_core/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/7B_check_acc.py` & `InternEvo-0.4.8/tests/test_training/7B_check_acc.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/7B_check_init.py` & `InternEvo-0.4.8/tests/test_training/7B_check_init.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/test_forward_output_no_fa.py` & `InternEvo-0.4.8/tests/test_training/test_forward_output_no_fa.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/test_load_ckpt_loss.py` & `InternEvo-0.4.8/tests/test_training/test_load_ckpt_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/test_loss.py` & `InternEvo-0.4.8/tests/test_training/test_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/test_no_fa_train_temp.py` & `InternEvo-0.4.8/tests/test_training/test_no_fa_train_temp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/test_norm_weight.py` & `InternEvo-0.4.8/tests/test_training/test_norm_weight.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/test_swap_nb_loss_and_gradnorm.py` & `InternEvo-0.4.8/tests/test_training/test_swap_nb_loss_and_gradnorm.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.6/tests/test_training/train_CI.py` & `InternEvo-0.4.8/tests/test_training/train_CI.py`
