# Comparing `tmp/lusid_sdk-2.1.97.tar.gz` & `tmp/lusid_sdk-2.1.98.tar.gz`
...
### Comparing `lusid_sdk-2.1.97/README.md` & `lusid_sdk-2.1.98/README.md`
...
### Comparing `lusid_sdk-2.1.97/lusid/__init__.py` & `lusid_sdk-2.1.98/lusid/__init__.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/__init__.py` & `lusid_sdk-2.1.98/lusid/api/__init__.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/abor_api.py` & `lusid_sdk-2.1.98/lusid/api/abor_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/abor_configuration_api.py` & `lusid_sdk-2.1.98/lusid/api/abor_configuration_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/address_key_definition_api.py` & `lusid_sdk-2.1.98/lusid/api/address_key_definition_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/aggregation_api.py` & `lusid_sdk-2.1.98/lusid/api/aggregation_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/allocations_api.py` & `lusid_sdk-2.1.98/lusid/api/allocations_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/amortisation_rule_sets_api.py` & `lusid_sdk-2.1.98/lusid/api/amortisation_rule_sets_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/application_metadata_api.py` & `lusid_sdk-2.1.98/lusid/api/application_metadata_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/blocks_api.py` & `lusid_sdk-2.1.98/lusid/api/blocks_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/calendars_api.py` & `lusid_sdk-2.1.98/lusid/api/calendars_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/chart_of_accounts_api.py` & `lusid_sdk-2.1.98/lusid/api/chart_of_accounts_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/complex_market_data_api.py` & `lusid_sdk-2.1.98/lusid/api/complex_market_data_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/compliance_api.py` & `lusid_sdk-2.1.98/lusid/api/compliance_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/configuration_recipe_api.py` & `lusid_sdk-2.1.98/lusid/api/configuration_recipe_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/conventions_api.py` & `lusid_sdk-2.1.98/lusid/api/conventions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/corporate_action_sources_api.py` & `lusid_sdk-2.1.98/lusid/api/corporate_action_sources_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/counterparties_api.py` & `lusid_sdk-2.1.98/lusid/api/counterparties_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/custom_entities_api.py` & `lusid_sdk-2.1.98/lusid/api/custom_entities_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/custom_entity_definitions_api.py` & `lusid_sdk-2.1.98/lusid/api/custom_entity_definitions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/custom_entity_types_api.py` & `lusid_sdk-2.1.98/lusid/api/custom_entity_types_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/cut_label_definitions_api.py` & `lusid_sdk-2.1.98/lusid/api/cut_label_definitions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/data_types_api.py` & `lusid_sdk-2.1.98/lusid/api/data_types_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/derived_transaction_portfolios_api.py` & `lusid_sdk-2.1.98/lusid/api/derived_transaction_portfolios_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/entities_api.py` & `lusid_sdk-2.1.98/lusid/api/entities_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/executions_api.py` & `lusid_sdk-2.1.98/lusid/api/executions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/funds_api.py` & `lusid_sdk-2.1.98/lusid/api/funds_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/instrument_event_types_api.py` & `lusid_sdk-2.1.98/lusid/api/instrument_event_types_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/instrument_events_api.py` & `lusid_sdk-2.1.98/lusid/api/instrument_events_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/instruments_api.py` & `lusid_sdk-2.1.98/lusid/api/instruments_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/legacy_compliance_api.py` & `lusid_sdk-2.1.98/lusid/api/legacy_compliance_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/legal_entities_api.py` & `lusid_sdk-2.1.98/lusid/api/legal_entities_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/order_graph_api.py` & `lusid_sdk-2.1.98/lusid/api/order_graph_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/order_instructions_api.py` & `lusid_sdk-2.1.98/lusid/api/order_instructions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/order_management_api.py` & `lusid_sdk-2.1.98/lusid/api/order_management_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/orders_api.py` & `lusid_sdk-2.1.98/lusid/api/orders_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/packages_api.py` & `lusid_sdk-2.1.98/lusid/api/packages_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/participations_api.py` & `lusid_sdk-2.1.98/lusid/api/participations_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/persons_api.py` & `lusid_sdk-2.1.98/lusid/api/persons_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/placements_api.py` & `lusid_sdk-2.1.98/lusid/api/placements_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/portfolio_groups_api.py` & `lusid_sdk-2.1.98/lusid/api/portfolio_groups_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/portfolios_api.py` & `lusid_sdk-2.1.98/lusid/api/portfolios_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/property_definitions_api.py` & `lusid_sdk-2.1.98/lusid/api/property_definitions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/queryable_keys_api.py` & `lusid_sdk-2.1.98/lusid/api/queryable_keys_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/quotes_api.py` & `lusid_sdk-2.1.98/lusid/api/quotes_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/reconciliations_api.py` & `lusid_sdk-2.1.98/lusid/api/reconciliations_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/reference_lists_api.py` & `lusid_sdk-2.1.98/lusid/api/reference_lists_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/reference_portfolio_api.py` & `lusid_sdk-2.1.98/lusid/api/reference_portfolio_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/relation_definitions_api.py` & `lusid_sdk-2.1.98/lusid/api/relation_definitions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/relations_api.py` & `lusid_sdk-2.1.98/lusid/api/relations_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/relationship_definitions_api.py` & `lusid_sdk-2.1.98/lusid/api/relationship_definitions_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/relationships_api.py` & `lusid_sdk-2.1.98/lusid/api/relationships_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/schemas_api.py` & `lusid_sdk-2.1.98/lusid/api/schemas_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/scopes_api.py` & `lusid_sdk-2.1.98/lusid/api/scopes_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/scripted_translation_api.py` & `lusid_sdk-2.1.98/lusid/api/scripted_translation_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/search_api.py` & `lusid_sdk-2.1.98/lusid/api/search_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/sequences_api.py` & `lusid_sdk-2.1.98/lusid/api/sequences_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/staged_modifications_api.py` & `lusid_sdk-2.1.98/lusid/api/staged_modifications_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/staging_rule_set_api.py` & `lusid_sdk-2.1.98/lusid/api/staging_rule_set_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/structured_result_data_api.py` & `lusid_sdk-2.1.98/lusid/api/structured_result_data_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/system_configuration_api.py` & `lusid_sdk-2.1.98/lusid/api/system_configuration_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/tax_rule_sets_api.py` & `lusid_sdk-2.1.98/lusid/api/tax_rule_sets_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/transaction_configuration_api.py` & `lusid_sdk-2.1.98/lusid/api/transaction_configuration_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/transaction_fees_api.py` & `lusid_sdk-2.1.98/lusid/api/transaction_fees_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/transaction_portfolios_api.py` & `lusid_sdk-2.1.98/lusid/api/transaction_portfolios_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api/translation_api.py` & `lusid_sdk-2.1.98/lusid/api/translation_api.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api_client.py` & `lusid_sdk-2.1.98/lusid/api_client.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/api_response.py` & `lusid_sdk-2.1.98/lusid/api_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/configuration.py` & `lusid_sdk-2.1.98/lusid/configuration.py`
...
### Comparing `lusid_sdk-2.1.97/lusid/exceptions.py` & `lusid_sdk-2.1.98/lusid/exceptions.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/__init__.py` & `lusid_sdk-2.1.98/lusid/extensions/__init__.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/api_client.py` & `lusid_sdk-2.1.98/lusid/extensions/api_client.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/api_client_factory.py` & `lusid_sdk-2.1.98/lusid/extensions/api_client_factory.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/api_configuration.py` & `lusid_sdk-2.1.98/lusid/extensions/api_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/configuration_loaders.py` & `lusid_sdk-2.1.98/lusid/extensions/configuration_loaders.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/proxy_config.py` & `lusid_sdk-2.1.98/lusid/extensions/proxy_config.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/refreshing_token.py` & `lusid_sdk-2.1.98/lusid/extensions/refreshing_token.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/rest.py` & `lusid_sdk-2.1.98/lusid/extensions/rest.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/retry.py` & `lusid_sdk-2.1.98/lusid/extensions/retry.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/socket_keep_alive.py` & `lusid_sdk-2.1.98/lusid/extensions/socket_keep_alive.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/extensions/tcp_keep_alive_connector.py` & `lusid_sdk-2.1.98/lusid/extensions/tcp_keep_alive_connector.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/__init__.py` & `lusid_sdk-2.1.98/lusid/models/__init__.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/a2_b_breakdown.py` & `lusid_sdk-2.1.98/lusid/models/a2_b_breakdown.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/a2_b_category.py` & `lusid_sdk-2.1.98/lusid/models/a2_b_category.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/a2_b_data_record.py` & `lusid_sdk-2.1.98/lusid/models/a2_b_data_record.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/a2_b_movement_record.py` & `lusid_sdk-2.1.98/lusid/models/a2_b_movement_record.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/abor.py` & `lusid_sdk-2.1.98/lusid/models/abor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/abor_configuration.py` & `lusid_sdk-2.1.98/lusid/models/abor_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/abor_configuration_properties.py` & `lusid_sdk-2.1.98/lusid/models/abor_configuration_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/abor_configuration_request.py` & `lusid_sdk-2.1.98/lusid/models/abor_configuration_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/abor_properties.py` & `lusid_sdk-2.1.98/lusid/models/abor_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/abor_request.py` & `lusid_sdk-2.1.98/lusid/models/abor_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/access_controlled_action.py` & `lusid_sdk-2.1.98/lusid/models/access_controlled_action.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/access_controlled_resource.py` & `lusid_sdk-2.1.98/lusid/models/access_controlled_resource.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/access_metadata_operation.py` & `lusid_sdk-2.1.98/lusid/models/access_metadata_operation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/access_metadata_value.py` & `lusid_sdk-2.1.98/lusid/models/access_metadata_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/account.py` & `lusid_sdk-2.1.98/lusid/models/account.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/account_properties.py` & `lusid_sdk-2.1.98/lusid/models/account_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/accounting_method.py` & `lusid_sdk-2.1.98/lusid/models/accounting_method.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/accounts_upsert_response.py` & `lusid_sdk-2.1.98/lusid/models/accounts_upsert_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/accumulation_event.py` & `lusid_sdk-2.1.98/lusid/models/accumulation_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/action_id.py` & `lusid_sdk-2.1.98/lusid/models/action_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/add_business_days_to_date_request.py` & `lusid_sdk-2.1.98/lusid/models/add_business_days_to_date_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/add_business_days_to_date_response.py` & `lusid_sdk-2.1.98/lusid/models/add_business_days_to_date_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/additional_payment.py` & `lusid_sdk-2.1.98/lusid/models/additional_payment.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_definition.py` & `lusid_sdk-2.1.98/lusid/models/address_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_key_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/address_key_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_key_definition.py` & `lusid_sdk-2.1.98/lusid/models/address_key_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_key_filter.py` & `lusid_sdk-2.1.98/lusid/models/address_key_filter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_key_list.py` & `lusid_sdk-2.1.98/lusid/models/address_key_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_key_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/address_key_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/address_key_option_definition.py` & `lusid_sdk-2.1.98/lusid/models/address_key_option_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/adjust_holding.py` & `lusid_sdk-2.1.98/lusid/models/adjust_holding.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/adjust_holding_for_date_request.py` & `lusid_sdk-2.1.98/lusid/models/adjust_holding_for_date_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/adjust_holding_request.py` & `lusid_sdk-2.1.98/lusid/models/adjust_holding_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregate_spec.py` & `lusid_sdk-2.1.98/lusid/models/aggregate_spec.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregated_return.py` & `lusid_sdk-2.1.98/lusid/models/aggregated_return.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregated_returns_dispersion_request.py` & `lusid_sdk-2.1.98/lusid/models/aggregated_returns_dispersion_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregated_returns_request.py` & `lusid_sdk-2.1.98/lusid/models/aggregated_returns_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregated_returns_response.py` & `lusid_sdk-2.1.98/lusid/models/aggregated_returns_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregated_transactions_request.py` & `lusid_sdk-2.1.98/lusid/models/aggregated_transactions_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregation_context.py` & `lusid_sdk-2.1.98/lusid/models/aggregation_context.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregation_measure_failure_detail.py` & `lusid_sdk-2.1.98/lusid/models/aggregation_measure_failure_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregation_op.py` & `lusid_sdk-2.1.98/lusid/models/aggregation_op.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregation_options.py` & `lusid_sdk-2.1.98/lusid/models/aggregation_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregation_query.py` & `lusid_sdk-2.1.98/lusid/models/aggregation_query.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/aggregation_type.py` & `lusid_sdk-2.1.98/lusid/models/aggregation_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/allocation.py` & `lusid_sdk-2.1.98/lusid/models/allocation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/allocation_request.py` & `lusid_sdk-2.1.98/lusid/models/allocation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/allocation_service_run_response.py` & `lusid_sdk-2.1.98/lusid/models/allocation_service_run_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/allocation_set_request.py` & `lusid_sdk-2.1.98/lusid/models/allocation_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/amortisation_event.py` & `lusid_sdk-2.1.98/lusid/models/amortisation_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/amortisation_rule.py` & `lusid_sdk-2.1.98/lusid/models/amortisation_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/amortisation_rule_set.py` & `lusid_sdk-2.1.98/lusid/models/amortisation_rule_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/annul_quotes_response.py` & `lusid_sdk-2.1.98/lusid/models/annul_quotes_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/annul_single_structured_data_response.py` & `lusid_sdk-2.1.98/lusid/models/annul_single_structured_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/annul_structured_data_response.py` & `lusid_sdk-2.1.98/lusid/models/annul_structured_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/asset_class.py` & `lusid_sdk-2.1.98/lusid/models/asset_class.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/asset_leg.py` & `lusid_sdk-2.1.98/lusid/models/asset_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/barrier.py` & `lusid_sdk-2.1.98/lusid/models/barrier.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/basket.py` & `lusid_sdk-2.1.98/lusid/models/basket.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/basket_identifier.py` & `lusid_sdk-2.1.98/lusid/models/basket_identifier.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/batch_adjust_holdings_response.py` & `lusid_sdk-2.1.98/lusid/models/batch_adjust_holdings_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/batch_upsert_instrument_properties_response.py` & `lusid_sdk-2.1.98/lusid/models/batch_upsert_instrument_properties_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/batch_upsert_portfolio_transactions_response.py` & `lusid_sdk-2.1.98/lusid/models/batch_upsert_portfolio_transactions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/batch_upsert_property_definition_properties_response.py` & `lusid_sdk-2.1.98/lusid/models/batch_upsert_property_definition_properties_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block.py` & `lusid_sdk-2.1.98/lusid/models/block.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block_and_order_id_request.py` & `lusid_sdk-2.1.98/lusid/models/block_and_order_id_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block_and_orders.py` & `lusid_sdk-2.1.98/lusid/models/block_and_orders.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block_and_orders_create_request.py` & `lusid_sdk-2.1.98/lusid/models/block_and_orders_create_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block_and_orders_request.py` & `lusid_sdk-2.1.98/lusid/models/block_and_orders_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block_request.py` & `lusid_sdk-2.1.98/lusid/models/block_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/block_set_request.py` & `lusid_sdk-2.1.98/lusid/models/block_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/blocked_order_request.py` & `lusid_sdk-2.1.98/lusid/models/blocked_order_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bond.py` & `lusid_sdk-2.1.98/lusid/models/bond.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bond_coupon_event.py` & `lusid_sdk-2.1.98/lusid/models/bond_coupon_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bond_default_event.py` & `lusid_sdk-2.1.98/lusid/models/bond_default_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bond_principal_event.py` & `lusid_sdk-2.1.98/lusid/models/bond_principal_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/book_transactions_request.py` & `lusid_sdk-2.1.98/lusid/models/book_transactions_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/book_transactions_response.py` & `lusid_sdk-2.1.98/lusid/models/book_transactions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bool_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/bool_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bool_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/bool_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/branch_step.py` & `lusid_sdk-2.1.98/lusid/models/branch_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bucketed_cash_flow_request.py` & `lusid_sdk-2.1.98/lusid/models/bucketed_cash_flow_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bucketed_cash_flow_response.py` & `lusid_sdk-2.1.98/lusid/models/bucketed_cash_flow_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/bucketing_schedule.py` & `lusid_sdk-2.1.98/lusid/models/bucketing_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/calculation_info.py` & `lusid_sdk-2.1.98/lusid/models/calculation_info.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/calendar.py` & `lusid_sdk-2.1.98/lusid/models/calendar.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/calendar_date.py` & `lusid_sdk-2.1.98/lusid/models/calendar_date.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/calendar_dependency.py` & `lusid_sdk-2.1.98/lusid/models/calendar_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cap_floor.py` & `lusid_sdk-2.1.98/lusid/models/cap_floor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_dependency.py` & `lusid_sdk-2.1.98/lusid/models/cash_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_dividend_event.py` & `lusid_sdk-2.1.98/lusid/models/cash_dividend_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_election.py` & `lusid_sdk-2.1.98/lusid/models/cash_election.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_flow_event.py` & `lusid_sdk-2.1.98/lusid/models/cash_flow_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_flow_lineage.py` & `lusid_sdk-2.1.98/lusid/models/cash_flow_lineage.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_flow_value.py` & `lusid_sdk-2.1.98/lusid/models/cash_flow_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_flow_value_set.py` & `lusid_sdk-2.1.98/lusid/models/cash_flow_value_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_ladder_record.py` & `lusid_sdk-2.1.98/lusid/models/cash_ladder_record.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cash_perpetual.py` & `lusid_sdk-2.1.98/lusid/models/cash_perpetual.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cds_flow_conventions.py` & `lusid_sdk-2.1.98/lusid/models/cds_flow_conventions.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cds_index.py` & `lusid_sdk-2.1.98/lusid/models/cds_index.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cds_protection_detail_specification.py` & `lusid_sdk-2.1.98/lusid/models/cds_protection_detail_specification.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/change.py` & `lusid_sdk-2.1.98/lusid/models/change.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/change_history.py` & `lusid_sdk-2.1.98/lusid/models/change_history.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/change_history_action.py` & `lusid_sdk-2.1.98/lusid/models/change_history_action.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/change_item.py` & `lusid_sdk-2.1.98/lusid/models/change_item.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/chart_of_accounts.py` & `lusid_sdk-2.1.98/lusid/models/chart_of_accounts.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/chart_of_accounts_properties.py` & `lusid_sdk-2.1.98/lusid/models/chart_of_accounts_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/chart_of_accounts_request.py` & `lusid_sdk-2.1.98/lusid/models/chart_of_accounts_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/check_step.py` & `lusid_sdk-2.1.98/lusid/models/check_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cleardown_module_details.py` & `lusid_sdk-2.1.98/lusid/models/cleardown_module_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cleardown_module_request.py` & `lusid_sdk-2.1.98/lusid/models/cleardown_module_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cleardown_module_response.py` & `lusid_sdk-2.1.98/lusid/models/cleardown_module_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cleardown_module_rule.py` & `lusid_sdk-2.1.98/lusid/models/cleardown_module_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cleardown_module_rules_updated_response.py` & `lusid_sdk-2.1.98/lusid/models/cleardown_module_rules_updated_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/client.py` & `lusid_sdk-2.1.98/lusid/models/client.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/close_event.py` & `lusid_sdk-2.1.98/lusid/models/close_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/close_period_diary_entry_request.py` & `lusid_sdk-2.1.98/lusid/models/close_period_diary_entry_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/complete_portfolio.py` & `lusid_sdk-2.1.98/lusid/models/complete_portfolio.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/complete_relation.py` & `lusid_sdk-2.1.98/lusid/models/complete_relation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/complete_relationship.py` & `lusid_sdk-2.1.98/lusid/models/complete_relationship.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/complex_bond.py` & `lusid_sdk-2.1.98/lusid/models/complex_bond.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/complex_market_data.py` & `lusid_sdk-2.1.98/lusid/models/complex_market_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/complex_market_data_id.py` & `lusid_sdk-2.1.98/lusid/models/complex_market_data_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_breached_order_info.py` & `lusid_sdk-2.1.98/lusid/models/compliance_breached_order_info.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_parameter_type.py` & `lusid_sdk-2.1.98/lusid/models/compliance_parameter_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_breakdown.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_breakdown.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_breakdown_request.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_breakdown_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_response.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_result.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_result_detail.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_result_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_result_portfolio_detail.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_result_portfolio_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_result_v2.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_result_v2.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_upsert_request.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_upsert_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_rule_upsert_response.py` & `lusid_sdk-2.1.98/lusid/models/compliance_rule_upsert_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_run_info.py` & `lusid_sdk-2.1.98/lusid/models/compliance_run_info.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_run_info_v2.py` & `lusid_sdk-2.1.98/lusid/models/compliance_run_info_v2.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_step.py` & `lusid_sdk-2.1.98/lusid/models/compliance_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_step_type.py` & `lusid_sdk-2.1.98/lusid/models/compliance_step_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_summary_rule_result.py` & `lusid_sdk-2.1.98/lusid/models/compliance_summary_rule_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_summary_rule_result_request.py` & `lusid_sdk-2.1.98/lusid/models/compliance_summary_rule_result_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_template.py` & `lusid_sdk-2.1.98/lusid/models/compliance_template.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_template_parameter.py` & `lusid_sdk-2.1.98/lusid/models/compliance_template_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compliance_template_variation.py` & `lusid_sdk-2.1.98/lusid/models/compliance_template_variation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/component_transaction.py` & `lusid_sdk-2.1.98/lusid/models/component_transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/composite_breakdown.py` & `lusid_sdk-2.1.98/lusid/models/composite_breakdown.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/composite_breakdown_request.py` & `lusid_sdk-2.1.98/lusid/models/composite_breakdown_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/composite_breakdown_response.py` & `lusid_sdk-2.1.98/lusid/models/composite_breakdown_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/composite_dispersion.py` & `lusid_sdk-2.1.98/lusid/models/composite_dispersion.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/composite_dispersion_response.py` & `lusid_sdk-2.1.98/lusid/models/composite_dispersion_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/compounding.py` & `lusid_sdk-2.1.98/lusid/models/compounding.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/configuration_recipe.py` & `lusid_sdk-2.1.98/lusid/models/configuration_recipe.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/constant_volatility_surface.py` & `lusid_sdk-2.1.98/lusid/models/constant_volatility_surface.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/constituents_adjustment_header.py` & `lusid_sdk-2.1.98/lusid/models/constituents_adjustment_header.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/contract_for_difference.py` & `lusid_sdk-2.1.98/lusid/models/contract_for_difference.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/corporate_action.py` & `lusid_sdk-2.1.98/lusid/models/corporate_action.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/corporate_action_source.py` & `lusid_sdk-2.1.98/lusid/models/corporate_action_source.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/corporate_action_transition.py` & `lusid_sdk-2.1.98/lusid/models/corporate_action_transition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/corporate_action_transition_component.py` & `lusid_sdk-2.1.98/lusid/models/corporate_action_transition_component.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/corporate_action_transition_component_request.py` & `lusid_sdk-2.1.98/lusid/models/corporate_action_transition_component_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/corporate_action_transition_request.py` & `lusid_sdk-2.1.98/lusid/models/corporate_action_transition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/counterparty_agreement.py` & `lusid_sdk-2.1.98/lusid/models/counterparty_agreement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/counterparty_risk_information.py` & `lusid_sdk-2.1.98/lusid/models/counterparty_risk_information.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/counterparty_signatory.py` & `lusid_sdk-2.1.98/lusid/models/counterparty_signatory.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_address_key_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/create_address_key_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_amortisation_rule_set_request.py` & `lusid_sdk-2.1.98/lusid/models/create_amortisation_rule_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_calendar_request.py` & `lusid_sdk-2.1.98/lusid/models/create_calendar_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_corporate_action_source_request.py` & `lusid_sdk-2.1.98/lusid/models/create_corporate_action_source_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_custom_entity_type_request.py` & `lusid_sdk-2.1.98/lusid/models/create_custom_entity_type_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_cut_label_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/create_cut_label_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_data_map_request.py` & `lusid_sdk-2.1.98/lusid/models/create_data_map_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_data_type_request.py` & `lusid_sdk-2.1.98/lusid/models/create_data_type_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_date_request.py` & `lusid_sdk-2.1.98/lusid/models/create_date_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_derived_property_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/create_derived_property_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_derived_transaction_portfolio_request.py` & `lusid_sdk-2.1.98/lusid/models/create_derived_transaction_portfolio_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_portfolio_details.py` & `lusid_sdk-2.1.98/lusid/models/create_portfolio_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_portfolio_group_request.py` & `lusid_sdk-2.1.98/lusid/models/create_portfolio_group_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_property_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/create_property_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_recipe_request.py` & `lusid_sdk-2.1.98/lusid/models/create_recipe_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/create_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_reference_portfolio_request.py` & `lusid_sdk-2.1.98/lusid/models/create_reference_portfolio_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_relation_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/create_relation_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_relation_request.py` & `lusid_sdk-2.1.98/lusid/models/create_relation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_relationship_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/create_relationship_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_relationship_request.py` & `lusid_sdk-2.1.98/lusid/models/create_relationship_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_sequence_request.py` & `lusid_sdk-2.1.98/lusid/models/create_sequence_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_staging_rule_set_request.py` & `lusid_sdk-2.1.98/lusid/models/create_staging_rule_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_tax_rule_set_request.py` & `lusid_sdk-2.1.98/lusid/models/create_tax_rule_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_trade_tickets_response.py` & `lusid_sdk-2.1.98/lusid/models/create_trade_tickets_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_transaction_portfolio_request.py` & `lusid_sdk-2.1.98/lusid/models/create_transaction_portfolio_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/create_unit_definition.py` & `lusid_sdk-2.1.98/lusid/models/create_unit_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/credit_default_swap.py` & `lusid_sdk-2.1.98/lusid/models/credit_default_swap.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/credit_rating.py` & `lusid_sdk-2.1.98/lusid/models/credit_rating.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/credit_spread_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/credit_spread_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/credit_support_annex.py` & `lusid_sdk-2.1.98/lusid/models/credit_support_annex.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/criterion_type.py` & `lusid_sdk-2.1.98/lusid/models/criterion_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/currency_and_amount.py` & `lusid_sdk-2.1.98/lusid/models/currency_and_amount.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/curve_options.py` & `lusid_sdk-2.1.98/lusid/models/curve_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custodian_account.py` & `lusid_sdk-2.1.98/lusid/models/custodian_account.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custodian_account_properties.py` & `lusid_sdk-2.1.98/lusid/models/custodian_account_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custodian_account_request.py` & `lusid_sdk-2.1.98/lusid/models/custodian_account_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custodian_accounts_upsert_response.py` & `lusid_sdk-2.1.98/lusid/models/custodian_accounts_upsert_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_definition.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_field.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_field.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_field_definition.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_field_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_id.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_request.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_response.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/custom_entity_type.py` & `lusid_sdk-2.1.98/lusid/models/custom_entity_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cut_label_definition.py` & `lusid_sdk-2.1.98/lusid/models/cut_label_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/cut_local_time.py` & `lusid_sdk-2.1.98/lusid/models/cut_local_time.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_definition.py` & `lusid_sdk-2.1.98/lusid/models/data_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_map_key.py` & `lusid_sdk-2.1.98/lusid/models/data_map_key.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_mapping.py` & `lusid_sdk-2.1.98/lusid/models/data_mapping.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_scope.py` & `lusid_sdk-2.1.98/lusid/models/data_scope.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_type.py` & `lusid_sdk-2.1.98/lusid/models/data_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_type_summary.py` & `lusid_sdk-2.1.98/lusid/models/data_type_summary.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/data_type_value_range.py` & `lusid_sdk-2.1.98/lusid/models/data_type_value_range.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/date_attributes.py` & `lusid_sdk-2.1.98/lusid/models/date_attributes.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/date_or_diary_entry.py` & `lusid_sdk-2.1.98/lusid/models/date_or_diary_entry.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/date_range.py` & `lusid_sdk-2.1.98/lusid/models/date_range.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/date_time_comparison_type.py` & `lusid_sdk-2.1.98/lusid/models/date_time_comparison_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/date_time_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/date_time_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/date_time_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/date_time_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/day_month.py` & `lusid_sdk-2.1.98/lusid/models/day_month.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/day_of_week.py` & `lusid_sdk-2.1.98/lusid/models/day_of_week.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/decimal_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/decimal_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/decimal_list.py` & `lusid_sdk-2.1.98/lusid/models/decimal_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/decimal_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/decimal_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/decorated_compliance_run_summary.py` & `lusid_sdk-2.1.98/lusid/models/decorated_compliance_run_summary.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_accounts_response.py` & `lusid_sdk-2.1.98/lusid/models/delete_accounts_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_custodian_accounts_response.py` & `lusid_sdk-2.1.98/lusid/models/delete_custodian_accounts_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_instrument_properties_response.py` & `lusid_sdk-2.1.98/lusid/models/delete_instrument_properties_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_instrument_response.py` & `lusid_sdk-2.1.98/lusid/models/delete_instrument_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_instruments_response.py` & `lusid_sdk-2.1.98/lusid/models/delete_instruments_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_modes.py` & `lusid_sdk-2.1.98/lusid/models/delete_modes.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_relation_request.py` & `lusid_sdk-2.1.98/lusid/models/delete_relation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/delete_relationship_request.py` & `lusid_sdk-2.1.98/lusid/models/delete_relationship_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/deleted_entity_response.py` & `lusid_sdk-2.1.98/lusid/models/deleted_entity_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/dependency_source_filter.py` & `lusid_sdk-2.1.98/lusid/models/dependency_source_filter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/described_address_key.py` & `lusid_sdk-2.1.98/lusid/models/described_address_key.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/dialect.py` & `lusid_sdk-2.1.98/lusid/models/dialect.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/dialect_id.py` & `lusid_sdk-2.1.98/lusid/models/dialect_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/dialect_schema.py` & `lusid_sdk-2.1.98/lusid/models/dialect_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/diary_entry.py` & `lusid_sdk-2.1.98/lusid/models/diary_entry.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/diary_entry_request.py` & `lusid_sdk-2.1.98/lusid/models/diary_entry_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/discount_factor_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/discount_factor_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/discounting_dependency.py` & `lusid_sdk-2.1.98/lusid/models/discounting_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/discounting_method.py` & `lusid_sdk-2.1.98/lusid/models/discounting_method.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/dividend_option_event.py` & `lusid_sdk-2.1.98/lusid/models/dividend_option_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/dividend_reinvestment_event.py` & `lusid_sdk-2.1.98/lusid/models/dividend_reinvestment_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/economic_dependency.py` & `lusid_sdk-2.1.98/lusid/models/economic_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/economic_dependency_type.py` & `lusid_sdk-2.1.98/lusid/models/economic_dependency_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/economic_dependency_with_complex_market_data.py` & `lusid_sdk-2.1.98/lusid/models/economic_dependency_with_complex_market_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/economic_dependency_with_quote.py` & `lusid_sdk-2.1.98/lusid/models/economic_dependency_with_quote.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/election_specification.py` & `lusid_sdk-2.1.98/lusid/models/election_specification.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/eligibility_calculation.py` & `lusid_sdk-2.1.98/lusid/models/eligibility_calculation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/empty_model_options.py` & `lusid_sdk-2.1.98/lusid/models/empty_model_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/entity_identifier.py` & `lusid_sdk-2.1.98/lusid/models/entity_identifier.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity.py` & `lusid_sdk-2.1.98/lusid/models/equity.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_all_of_identifiers.py` & `lusid_sdk-2.1.98/lusid/models/equity_all_of_identifiers.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_curve_by_prices_data.py` & `lusid_sdk-2.1.98/lusid/models/equity_curve_by_prices_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_curve_dependency.py` & `lusid_sdk-2.1.98/lusid/models/equity_curve_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_model_options.py` & `lusid_sdk-2.1.98/lusid/models/equity_model_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_option.py` & `lusid_sdk-2.1.98/lusid/models/equity_option.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_swap.py` & `lusid_sdk-2.1.98/lusid/models/equity_swap.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_vol_dependency.py` & `lusid_sdk-2.1.98/lusid/models/equity_vol_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/equity_vol_surface_data.py` & `lusid_sdk-2.1.98/lusid/models/equity_vol_surface_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/error_detail.py` & `lusid_sdk-2.1.98/lusid/models/error_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/event_date_range.py` & `lusid_sdk-2.1.98/lusid/models/event_date_range.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/ex_dividend_configuration.py` & `lusid_sdk-2.1.98/lusid/models/ex_dividend_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/exchange_traded_option.py` & `lusid_sdk-2.1.98/lusid/models/exchange_traded_option.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/exchange_traded_option_contract_details.py` & `lusid_sdk-2.1.98/lusid/models/exchange_traded_option_contract_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/execution.py` & `lusid_sdk-2.1.98/lusid/models/execution.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/execution_request.py` & `lusid_sdk-2.1.98/lusid/models/execution_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/execution_set_request.py` & `lusid_sdk-2.1.98/lusid/models/execution_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/exercise_event.py` & `lusid_sdk-2.1.98/lusid/models/exercise_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/exotic_instrument.py` & `lusid_sdk-2.1.98/lusid/models/exotic_instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/expanded_group.py` & `lusid_sdk-2.1.98/lusid/models/expanded_group.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/expiry_event.py` & `lusid_sdk-2.1.98/lusid/models/expiry_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fee_rule.py` & `lusid_sdk-2.1.98/lusid/models/fee_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fee_rule_upsert_request.py` & `lusid_sdk-2.1.98/lusid/models/fee_rule_upsert_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fee_rule_upsert_response.py` & `lusid_sdk-2.1.98/lusid/models/fee_rule_upsert_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/field_definition.py` & `lusid_sdk-2.1.98/lusid/models/field_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/field_schema.py` & `lusid_sdk-2.1.98/lusid/models/field_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/field_value.py` & `lusid_sdk-2.1.98/lusid/models/field_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/file_response.py` & `lusid_sdk-2.1.98/lusid/models/file_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/filter_predicate_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/filter_predicate_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/filter_step.py` & `lusid_sdk-2.1.98/lusid/models/filter_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fixed_leg.py` & `lusid_sdk-2.1.98/lusid/models/fixed_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fixed_leg_all_of_overrides.py` & `lusid_sdk-2.1.98/lusid/models/fixed_leg_all_of_overrides.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fixed_schedule.py` & `lusid_sdk-2.1.98/lusid/models/fixed_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/flexible_loan.py` & `lusid_sdk-2.1.98/lusid/models/flexible_loan.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/float_schedule.py` & `lusid_sdk-2.1.98/lusid/models/float_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/floating_leg.py` & `lusid_sdk-2.1.98/lusid/models/floating_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/flow_convention_name.py` & `lusid_sdk-2.1.98/lusid/models/flow_convention_name.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/flow_conventions.py` & `lusid_sdk-2.1.98/lusid/models/flow_conventions.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/forward_rate_agreement.py` & `lusid_sdk-2.1.98/lusid/models/forward_rate_agreement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/from_recipe.py` & `lusid_sdk-2.1.98/lusid/models/from_recipe.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fund.py` & `lusid_sdk-2.1.98/lusid/models/fund.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fund_properties.py` & `lusid_sdk-2.1.98/lusid/models/fund_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fund_request.py` & `lusid_sdk-2.1.98/lusid/models/fund_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fund_share_class.py` & `lusid_sdk-2.1.98/lusid/models/fund_share_class.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/funding_leg.py` & `lusid_sdk-2.1.98/lusid/models/funding_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/funding_leg_options.py` & `lusid_sdk-2.1.98/lusid/models/funding_leg_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/future.py` & `lusid_sdk-2.1.98/lusid/models/future.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/futures_contract_details.py` & `lusid_sdk-2.1.98/lusid/models/futures_contract_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_conventions.py` & `lusid_sdk-2.1.98/lusid/models/fx_conventions.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_dependency.py` & `lusid_sdk-2.1.98/lusid/models/fx_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_curve_by_quote_reference.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_curve_by_quote_reference.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_model_options.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_model_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_pips_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_pips_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_settlement_event.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_settlement_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_tenor_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_tenor_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forward_tenor_pips_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/fx_forward_tenor_pips_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_forwards_dependency.py` & `lusid_sdk-2.1.98/lusid/models/fx_forwards_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_linked_notional_schedule.py` & `lusid_sdk-2.1.98/lusid/models/fx_linked_notional_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_option.py` & `lusid_sdk-2.1.98/lusid/models/fx_option.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_rate_schedule.py` & `lusid_sdk-2.1.98/lusid/models/fx_rate_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_swap.py` & `lusid_sdk-2.1.98/lusid/models/fx_swap.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_tenor_convention.py` & `lusid_sdk-2.1.98/lusid/models/fx_tenor_convention.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_vol_dependency.py` & `lusid_sdk-2.1.98/lusid/models/fx_vol_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/fx_vol_surface_data.py` & `lusid_sdk-2.1.98/lusid/models/fx_vol_surface_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/general_ledger_profile_mapping.py` & `lusid_sdk-2.1.98/lusid/models/general_ledger_profile_mapping.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/general_ledger_profile_request.py` & `lusid_sdk-2.1.98/lusid/models/general_ledger_profile_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/general_ledger_profile_response.py` & `lusid_sdk-2.1.98/lusid/models/general_ledger_profile_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_cds_flow_conventions_response.py` & `lusid_sdk-2.1.98/lusid/models/get_cds_flow_conventions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_complex_market_data_response.py` & `lusid_sdk-2.1.98/lusid/models/get_complex_market_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_counterparty_agreement_response.py` & `lusid_sdk-2.1.98/lusid/models/get_counterparty_agreement_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_credit_support_annex_response.py` & `lusid_sdk-2.1.98/lusid/models/get_credit_support_annex_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_data_map_response.py` & `lusid_sdk-2.1.98/lusid/models/get_data_map_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_flow_conventions_response.py` & `lusid_sdk-2.1.98/lusid/models/get_flow_conventions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_index_convention_response.py` & `lusid_sdk-2.1.98/lusid/models/get_index_convention_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_instruments_response.py` & `lusid_sdk-2.1.98/lusid/models/get_instruments_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_quotes_response.py` & `lusid_sdk-2.1.98/lusid/models/get_quotes_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_recipe_composer_response.py` & `lusid_sdk-2.1.98/lusid/models/get_recipe_composer_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_recipe_response.py` & `lusid_sdk-2.1.98/lusid/models/get_recipe_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_reference_portfolio_constituents_response.py` & `lusid_sdk-2.1.98/lusid/models/get_reference_portfolio_constituents_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_structured_result_data_response.py` & `lusid_sdk-2.1.98/lusid/models/get_structured_result_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/get_virtual_document_response.py` & `lusid_sdk-2.1.98/lusid/models/get_virtual_document_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/group_by_selector_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/group_by_selector_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/group_by_step.py` & `lusid_sdk-2.1.98/lusid/models/group_by_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/group_filter_predicate_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/group_filter_predicate_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/group_filter_step.py` & `lusid_sdk-2.1.98/lusid/models/group_filter_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/group_of_market_data_key_rules.py` & `lusid_sdk-2.1.98/lusid/models/group_of_market_data_key_rules.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/grouped_result_of_address_key.py` & `lusid_sdk-2.1.98/lusid/models/grouped_result_of_address_key.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/holding_adjustment.py` & `lusid_sdk-2.1.98/lusid/models/holding_adjustment.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/holding_adjustment_with_date.py` & `lusid_sdk-2.1.98/lusid/models/holding_adjustment_with_date.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/holding_context.py` & `lusid_sdk-2.1.98/lusid/models/holding_context.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/holding_contributor.py` & `lusid_sdk-2.1.98/lusid/models/holding_contributor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/holdings_adjustment.py` & `lusid_sdk-2.1.98/lusid/models/holdings_adjustment.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/holdings_adjustment_header.py` & `lusid_sdk-2.1.98/lusid/models/holdings_adjustment_header.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/i_unit_definition_dto.py` & `lusid_sdk-2.1.98/lusid/models/i_unit_definition_dto.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/id_selector_definition.py` & `lusid_sdk-2.1.98/lusid/models/id_selector_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/identifier_part_schema.py` & `lusid_sdk-2.1.98/lusid/models/identifier_part_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/index_convention.py` & `lusid_sdk-2.1.98/lusid/models/index_convention.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/index_model_options.py` & `lusid_sdk-2.1.98/lusid/models/index_model_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/index_projection_dependency.py` & `lusid_sdk-2.1.98/lusid/models/index_projection_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/industry_classifier.py` & `lusid_sdk-2.1.98/lusid/models/industry_classifier.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inflation_fixing_dependency.py` & `lusid_sdk-2.1.98/lusid/models/inflation_fixing_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inflation_index_conventions.py` & `lusid_sdk-2.1.98/lusid/models/inflation_index_conventions.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inflation_leg.py` & `lusid_sdk-2.1.98/lusid/models/inflation_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inflation_linked_bond.py` & `lusid_sdk-2.1.98/lusid/models/inflation_linked_bond.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inflation_swap.py` & `lusid_sdk-2.1.98/lusid/models/inflation_swap.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/informational_error_event.py` & `lusid_sdk-2.1.98/lusid/models/informational_error_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/informational_event.py` & `lusid_sdk-2.1.98/lusid/models/informational_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inline_valuation_request.py` & `lusid_sdk-2.1.98/lusid/models/inline_valuation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/inline_valuations_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/inline_valuations_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/input_transition.py` & `lusid_sdk-2.1.98/lusid/models/input_transition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument.py` & `lusid_sdk-2.1.98/lusid/models/instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_capabilities.py` & `lusid_sdk-2.1.98/lusid/models/instrument_capabilities.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_cash_flow.py` & `lusid_sdk-2.1.98/lusid/models/instrument_cash_flow.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_definition.py` & `lusid_sdk-2.1.98/lusid/models/instrument_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_definition_format.py` & `lusid_sdk-2.1.98/lusid/models/instrument_definition_format.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_delete_modes.py` & `lusid_sdk-2.1.98/lusid/models/instrument_delete_modes.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event_configuration.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event_holder.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event_holder.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event_instruction.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event_instruction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event_instruction_request.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event_instruction_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event_instructions_response.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event_instructions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_event_type.py` & `lusid_sdk-2.1.98/lusid/models/instrument_event_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_id_type_descriptor.py` & `lusid_sdk-2.1.98/lusid/models/instrument_id_type_descriptor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_id_value.py` & `lusid_sdk-2.1.98/lusid/models/instrument_id_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_leg.py` & `lusid_sdk-2.1.98/lusid/models/instrument_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_list.py` & `lusid_sdk-2.1.98/lusid/models/instrument_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/instrument_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_match.py` & `lusid_sdk-2.1.98/lusid/models/instrument_match.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_models.py` & `lusid_sdk-2.1.98/lusid/models/instrument_models.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_payment_diary.py` & `lusid_sdk-2.1.98/lusid/models/instrument_payment_diary.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_payment_diary_leg.py` & `lusid_sdk-2.1.98/lusid/models/instrument_payment_diary_leg.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_payment_diary_row.py` & `lusid_sdk-2.1.98/lusid/models/instrument_payment_diary_row.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_properties.py` & `lusid_sdk-2.1.98/lusid/models/instrument_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_resolution_detail.py` & `lusid_sdk-2.1.98/lusid/models/instrument_resolution_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_search_property.py` & `lusid_sdk-2.1.98/lusid/models/instrument_search_property.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/instrument_type.py` & `lusid_sdk-2.1.98/lusid/models/instrument_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/interest_rate_swap.py` & `lusid_sdk-2.1.98/lusid/models/interest_rate_swap.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/interest_rate_swaption.py` & `lusid_sdk-2.1.98/lusid/models/interest_rate_swaption.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/intermediate_compliance_step.py` & `lusid_sdk-2.1.98/lusid/models/intermediate_compliance_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/ir_vol_cube_data.py` & `lusid_sdk-2.1.98/lusid/models/ir_vol_cube_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/ir_vol_dependency.py` & `lusid_sdk-2.1.98/lusid/models/ir_vol_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/is_business_day_response.py` & `lusid_sdk-2.1.98/lusid/models/is_business_day_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/journal_entry_line.py` & `lusid_sdk-2.1.98/lusid/models/journal_entry_line.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/journal_entry_lines_query_parameters.py` & `lusid_sdk-2.1.98/lusid/models/journal_entry_lines_query_parameters.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/label_value_set.py` & `lusid_sdk-2.1.98/lusid/models/label_value_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/leg_definition.py` & `lusid_sdk-2.1.98/lusid/models/leg_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/legal_entity.py` & `lusid_sdk-2.1.98/lusid/models/legal_entity.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/level_step.py` & `lusid_sdk-2.1.98/lusid/models/level_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/life_cycle_event_lineage.py` & `lusid_sdk-2.1.98/lusid/models/life_cycle_event_lineage.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/life_cycle_event_value.py` & `lusid_sdk-2.1.98/lusid/models/life_cycle_event_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lineage_member.py` & `lusid_sdk-2.1.98/lusid/models/lineage_member.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/link.py` & `lusid_sdk-2.1.98/lusid/models/link.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/list_aggregation_reconciliation.py` & `lusid_sdk-2.1.98/lusid/models/list_aggregation_reconciliation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/list_aggregation_response.py` & `lusid_sdk-2.1.98/lusid/models/list_aggregation_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/list_complex_market_data_with_meta_data_response.py` & `lusid_sdk-2.1.98/lusid/models/list_complex_market_data_with_meta_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/loan_period.py` & `lusid_sdk-2.1.98/lusid/models/loan_period.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lock_period_diary_entry_request.py` & `lusid_sdk-2.1.98/lusid/models/lock_period_diary_entry_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lusid_instrument.py` & `lusid_sdk-2.1.98/lusid/models/lusid_instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lusid_problem_details.py` & `lusid_sdk-2.1.98/lusid/models/lusid_problem_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lusid_trade_ticket.py` & `lusid_sdk-2.1.98/lusid/models/lusid_trade_ticket.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lusid_unique_id.py` & `lusid_sdk-2.1.98/lusid/models/lusid_unique_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/lusid_validation_problem_details.py` & `lusid_sdk-2.1.98/lusid/models/lusid_validation_problem_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/mapped_string.py` & `lusid_sdk-2.1.98/lusid/models/mapped_string.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/mapping.py` & `lusid_sdk-2.1.98/lusid/models/mapping.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/mapping_rule.py` & `lusid_sdk-2.1.98/lusid/models/mapping_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_context.py` & `lusid_sdk-2.1.98/lusid/models/market_context.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_context_suppliers.py` & `lusid_sdk-2.1.98/lusid/models/market_context_suppliers.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_data_key_rule.py` & `lusid_sdk-2.1.98/lusid/models/market_data_key_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_data_options.py` & `lusid_sdk-2.1.98/lusid/models/market_data_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_data_options_type.py` & `lusid_sdk-2.1.98/lusid/models/market_data_options_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_data_overrides.py` & `lusid_sdk-2.1.98/lusid/models/market_data_overrides.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_data_specific_rule.py` & `lusid_sdk-2.1.98/lusid/models/market_data_specific_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_data_type.py` & `lusid_sdk-2.1.98/lusid/models/market_data_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_observable_type.py` & `lusid_sdk-2.1.98/lusid/models/market_observable_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_options.py` & `lusid_sdk-2.1.98/lusid/models/market_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/market_quote.py` & `lusid_sdk-2.1.98/lusid/models/market_quote.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/match_criterion.py` & `lusid_sdk-2.1.98/lusid/models/match_criterion.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/maturity_event.py` & `lusid_sdk-2.1.98/lusid/models/maturity_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/metric_value.py` & `lusid_sdk-2.1.98/lusid/models/metric_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/model_options.py` & `lusid_sdk-2.1.98/lusid/models/model_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/model_options_type.py` & `lusid_sdk-2.1.98/lusid/models/model_options_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/model_property.py` & `lusid_sdk-2.1.98/lusid/models/model_property.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/model_schema.py` & `lusid_sdk-2.1.98/lusid/models/model_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/model_selection.py` & `lusid_sdk-2.1.98/lusid/models/model_selection.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/move_orders_to_different_blocks_request.py` & `lusid_sdk-2.1.98/lusid/models/move_orders_to_different_blocks_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/moved_order_to_different_block_response.py` & `lusid_sdk-2.1.98/lusid/models/moved_order_to_different_block_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/movement_type.py` & `lusid_sdk-2.1.98/lusid/models/movement_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/multi_currency_amounts.py` & `lusid_sdk-2.1.98/lusid/models/multi_currency_amounts.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/next_value_in_sequence_response.py` & `lusid_sdk-2.1.98/lusid/models/next_value_in_sequence_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/numeric_comparison_type.py` & `lusid_sdk-2.1.98/lusid/models/numeric_comparison_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/opaque_dependency.py` & `lusid_sdk-2.1.98/lusid/models/opaque_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/opaque_market_data.py` & `lusid_sdk-2.1.98/lusid/models/opaque_market_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/opaque_model_options.py` & `lusid_sdk-2.1.98/lusid/models/opaque_model_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/open_event.py` & `lusid_sdk-2.1.98/lusid/models/open_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/operand_type.py` & `lusid_sdk-2.1.98/lusid/models/operand_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/operation.py` & `lusid_sdk-2.1.98/lusid/models/operation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/operation_type.py` & `lusid_sdk-2.1.98/lusid/models/operation_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/operator.py` & `lusid_sdk-2.1.98/lusid/models/operator.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/option_entry.py` & `lusid_sdk-2.1.98/lusid/models/option_entry.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/optionality_schedule.py` & `lusid_sdk-2.1.98/lusid/models/optionality_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order.py` & `lusid_sdk-2.1.98/lusid/models/order.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_by_spec.py` & `lusid_sdk-2.1.98/lusid/models/order_by_spec.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_flow_configuration.py` & `lusid_sdk-2.1.98/lusid/models/order_flow_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_allocation_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_allocation_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_allocation_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_allocation_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_execution_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_execution_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_execution_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_execution_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_order_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_order_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_order_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_order_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_placement_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_placement_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_placement_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_placement_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_transaction_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_transaction_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_block_transaction_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_block_transaction_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_allocation_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_allocation_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_allocation_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_allocation_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_child_placement_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_child_placement_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_execution_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_execution_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_execution_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_execution_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_order_detail.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_order_detail.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_order_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_order_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_graph_placement_placement_synopsis.py` & `lusid_sdk-2.1.98/lusid/models/order_graph_placement_placement_synopsis.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_instruction.py` & `lusid_sdk-2.1.98/lusid/models/order_instruction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_instruction_request.py` & `lusid_sdk-2.1.98/lusid/models/order_instruction_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_instruction_set_request.py` & `lusid_sdk-2.1.98/lusid/models/order_instruction_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_request.py` & `lusid_sdk-2.1.98/lusid/models/order_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/order_set_request.py` & `lusid_sdk-2.1.98/lusid/models/order_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/otc_confirmation.py` & `lusid_sdk-2.1.98/lusid/models/otc_confirmation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/output_transaction.py` & `lusid_sdk-2.1.98/lusid/models/output_transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/output_transition.py` & `lusid_sdk-2.1.98/lusid/models/output_transition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/package.py` & `lusid_sdk-2.1.98/lusid/models/package.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/package_request.py` & `lusid_sdk-2.1.98/lusid/models/package_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/package_set_request.py` & `lusid_sdk-2.1.98/lusid/models/package_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_abor.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_abor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_abor_configuration.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_abor_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_account.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_account.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_address_key_definition.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_address_key_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_allocation.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_allocation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_amortisation_rule_set.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_amortisation_rule_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_block.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_block.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_calendar.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_calendar.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_chart_of_accounts.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_chart_of_accounts.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_cleardown_module_response.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_cleardown_module_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_cleardown_module_rule.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_cleardown_module_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_compliance_rule_response.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_compliance_rule_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_compliance_run_info_v2.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_compliance_run_info_v2.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_compliance_template.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_compliance_template.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_corporate_action_source.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_corporate_action_source.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_custodian_account.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_custodian_account.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_custom_entity_definition.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_custom_entity_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_custom_entity_response.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_custom_entity_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_custom_entity_type.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_custom_entity_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_cut_label_definition.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_cut_label_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_data_type_summary.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_data_type_summary.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_dialect_id.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_dialect_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_diary_entry.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_diary_entry.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_execution.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_execution.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_fund.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_fund.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_general_ledger_profile_response.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_general_ledger_profile_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_instrument.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_instrument_event_holder.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_instrument_event_holder.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_legal_entity.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_legal_entity.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_order.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_order.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_order_graph_block.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_order_graph_block.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_order_graph_placement.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_order_graph_placement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_order_instruction.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_order_instruction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_package.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_package.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_participation.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_participation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_person.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_person.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_placement.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_placement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_portfolio_group.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_portfolio_group.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_portfolio_group_search_result.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_portfolio_group_search_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_portfolio_search_result.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_portfolio_search_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_posting_module_response.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_posting_module_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_posting_module_rule.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_posting_module_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_property_definition.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_property_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_property_definition_search_result.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_property_definition_search_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_reconciliation.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_reconciliation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_reference_list_response.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_reference_list_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_relationship_definition.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_relationship_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_sequence_definition.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_sequence_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_staged_modification.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_staged_modification.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_staged_modifications_requested_change_interval.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_staged_modifications_requested_change_interval.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_staging_rule_set.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_staging_rule_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_transaction_template.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_transaction_template.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_transaction_template_specification.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_transaction_template_specification.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_translation_script_id.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_translation_script_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/paged_resource_list_of_virtual_row.py` & `lusid_sdk-2.1.98/lusid/models/paged_resource_list_of_virtual_row.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/participation.py` & `lusid_sdk-2.1.98/lusid/models/participation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/participation_request.py` & `lusid_sdk-2.1.98/lusid/models/participation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/participation_set_request.py` & `lusid_sdk-2.1.98/lusid/models/participation_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/performance_return.py` & `lusid_sdk-2.1.98/lusid/models/performance_return.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/performance_returns_metric.py` & `lusid_sdk-2.1.98/lusid/models/performance_returns_metric.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/period_diary_entries_reopened_response.py` & `lusid_sdk-2.1.98/lusid/models/period_diary_entries_reopened_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/period_type.py` & `lusid_sdk-2.1.98/lusid/models/period_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/perpetual_entity_state.py` & `lusid_sdk-2.1.98/lusid/models/perpetual_entity_state.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/perpetual_property.py` & `lusid_sdk-2.1.98/lusid/models/perpetual_property.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/person.py` & `lusid_sdk-2.1.98/lusid/models/person.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/place_blocks_request.py` & `lusid_sdk-2.1.98/lusid/models/place_blocks_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/placement.py` & `lusid_sdk-2.1.98/lusid/models/placement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/placement_request.py` & `lusid_sdk-2.1.98/lusid/models/placement_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/placement_set_request.py` & `lusid_sdk-2.1.98/lusid/models/placement_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio.py` & `lusid_sdk-2.1.98/lusid/models/portfolio.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_cash_flow.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_cash_flow.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_cash_ladder.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_cash_ladder.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_details.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_entity.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_entity.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_entity_id.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_entity_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_group.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_group.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_group_id_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_group_id_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_group_id_list.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_group_id_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_group_id_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_group_id_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_group_properties.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_group_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_group_search_result.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_group_search_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_holding.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_holding.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_id_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_id_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_id_list.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_id_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_id_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_id_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_properties.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_properties.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_result_data_key_rule.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_result_data_key_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_return_breakdown.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_return_breakdown.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_search_result.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_search_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_trade_ticket.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_trade_ticket.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_type.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolio_without_href.py` & `lusid_sdk-2.1.98/lusid/models/portfolio_without_href.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/portfolios_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/portfolios_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/posting_module_details.py` & `lusid_sdk-2.1.98/lusid/models/posting_module_details.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/posting_module_request.py` & `lusid_sdk-2.1.98/lusid/models/posting_module_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/posting_module_response.py` & `lusid_sdk-2.1.98/lusid/models/posting_module_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/posting_module_rule.py` & `lusid_sdk-2.1.98/lusid/models/posting_module_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/posting_module_rules_updated_response.py` & `lusid_sdk-2.1.98/lusid/models/posting_module_rules_updated_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/premium.py` & `lusid_sdk-2.1.98/lusid/models/premium.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/pricing_context.py` & `lusid_sdk-2.1.98/lusid/models/pricing_context.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/pricing_model.py` & `lusid_sdk-2.1.98/lusid/models/pricing_model.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/pricing_options.py` & `lusid_sdk-2.1.98/lusid/models/pricing_options.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/processed_command.py` & `lusid_sdk-2.1.98/lusid/models/processed_command.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_definition.py` & `lusid_sdk-2.1.98/lusid/models/property_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_definition_search_result.py` & `lusid_sdk-2.1.98/lusid/models/property_definition_search_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_definition_type.py` & `lusid_sdk-2.1.98/lusid/models/property_definition_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_domain.py` & `lusid_sdk-2.1.98/lusid/models/property_domain.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_filter.py` & `lusid_sdk-2.1.98/lusid/models/property_filter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_interval.py` & `lusid_sdk-2.1.98/lusid/models/property_interval.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_key_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/property_key_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_key_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/property_key_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_life_time.py` & `lusid_sdk-2.1.98/lusid/models/property_life_time.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_list.py` & `lusid_sdk-2.1.98/lusid/models/property_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/property_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_schema.py` & `lusid_sdk-2.1.98/lusid/models/property_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_type.py` & `lusid_sdk-2.1.98/lusid/models/property_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_value.py` & `lusid_sdk-2.1.98/lusid/models/property_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_value_equals.py` & `lusid_sdk-2.1.98/lusid/models/property_value_equals.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/property_value_in.py` & `lusid_sdk-2.1.98/lusid/models/property_value_in.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/query_bucketed_cash_flows_request.py` & `lusid_sdk-2.1.98/lusid/models/query_bucketed_cash_flows_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/query_cash_flows_request.py` & `lusid_sdk-2.1.98/lusid/models/query_cash_flows_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/query_instrument_events_request.py` & `lusid_sdk-2.1.98/lusid/models/query_instrument_events_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/query_trade_tickets_request.py` & `lusid_sdk-2.1.98/lusid/models/query_trade_tickets_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/queryable_key.py` & `lusid_sdk-2.1.98/lusid/models/queryable_key.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote.py` & `lusid_sdk-2.1.98/lusid/models/quote.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_access_metadata_rule.py` & `lusid_sdk-2.1.98/lusid/models/quote_access_metadata_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_access_metadata_rule_id.py` & `lusid_sdk-2.1.98/lusid/models/quote_access_metadata_rule_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_dependency.py` & `lusid_sdk-2.1.98/lusid/models/quote_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_id.py` & `lusid_sdk-2.1.98/lusid/models/quote_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_instrument_id_type.py` & `lusid_sdk-2.1.98/lusid/models/quote_instrument_id_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_series_id.py` & `lusid_sdk-2.1.98/lusid/models/quote_series_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/quote_type.py` & `lusid_sdk-2.1.98/lusid/models/quote_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/raw_vendor_event.py` & `lusid_sdk-2.1.98/lusid/models/raw_vendor_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/re_open_period_diary_entry_request.py` & `lusid_sdk-2.1.98/lusid/models/re_open_period_diary_entry_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/realised_gain_loss.py` & `lusid_sdk-2.1.98/lusid/models/realised_gain_loss.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/recipe_block.py` & `lusid_sdk-2.1.98/lusid/models/recipe_block.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/recipe_composer.py` & `lusid_sdk-2.1.98/lusid/models/recipe_composer.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/recipe_value.py` & `lusid_sdk-2.1.98/lusid/models/recipe_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/recombine_step.py` & `lusid_sdk-2.1.98/lusid/models/recombine_step.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconcile_date_time_rule.py` & `lusid_sdk-2.1.98/lusid/models/reconcile_date_time_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconcile_numeric_rule.py` & `lusid_sdk-2.1.98/lusid/models/reconcile_numeric_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconcile_string_rule.py` & `lusid_sdk-2.1.98/lusid/models/reconcile_string_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciled_transaction.py` & `lusid_sdk-2.1.98/lusid/models/reconciled_transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_break.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_break.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_configuration.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_id.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_left_right_address_key_pair.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_left_right_address_key_pair.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_line.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_line.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_response.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_rule.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_rule_type.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_rule_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_side_configuration.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_side_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reconciliation_transactions.py` & `lusid_sdk-2.1.98/lusid/models/reconciliation_transactions.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_data.py` & `lusid_sdk-2.1.98/lusid/models/reference_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_instrument.py` & `lusid_sdk-2.1.98/lusid/models/reference_instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_list.py` & `lusid_sdk-2.1.98/lusid/models/reference_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_list_request.py` & `lusid_sdk-2.1.98/lusid/models/reference_list_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_list_response.py` & `lusid_sdk-2.1.98/lusid/models/reference_list_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_list_type.py` & `lusid_sdk-2.1.98/lusid/models/reference_list_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_portfolio_constituent.py` & `lusid_sdk-2.1.98/lusid/models/reference_portfolio_constituent.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_portfolio_constituent_request.py` & `lusid_sdk-2.1.98/lusid/models/reference_portfolio_constituent_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reference_portfolio_weight_type.py` & `lusid_sdk-2.1.98/lusid/models/reference_portfolio_weight_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/related_entity.py` & `lusid_sdk-2.1.98/lusid/models/related_entity.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/relation.py` & `lusid_sdk-2.1.98/lusid/models/relation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/relation_definition.py` & `lusid_sdk-2.1.98/lusid/models/relation_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/relationship.py` & `lusid_sdk-2.1.98/lusid/models/relationship.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/relationship_definition.py` & `lusid_sdk-2.1.98/lusid/models/relationship_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/relative_date_offset.py` & `lusid_sdk-2.1.98/lusid/models/relative_date_offset.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/repo.py` & `lusid_sdk-2.1.98/lusid/models/repo.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/requested_changes.py` & `lusid_sdk-2.1.98/lusid/models/requested_changes.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reset_event.py` & `lusid_sdk-2.1.98/lusid/models/reset_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_id.py` & `lusid_sdk-2.1.98/lusid/models/resource_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_access_controlled_resource.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_access_controlled_resource.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_access_metadata_value_of.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_access_metadata_value_of.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_address_key_definition.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_address_key_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_aggregated_return.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_aggregated_return.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_aggregation_query.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_aggregation_query.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_allocation.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_allocation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_block.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_block.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_block_and_orders.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_block_and_orders.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_calendar_date.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_calendar_date.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_change.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_change.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_change_history.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_change_history.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_compliance_breached_order_info.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_compliance_breached_order_info.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_compliance_rule.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_compliance_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_compliance_rule_result.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_compliance_rule_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_compliance_run_info.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_compliance_run_info.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_constituents_adjustment_header.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_constituents_adjustment_header.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_corporate_action.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_corporate_action.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_data_type.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_data_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_execution.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_execution.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_fee_rule.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_fee_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_cds_flow_conventions_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_cds_flow_conventions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_counterparty_agreement_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_counterparty_agreement_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_credit_support_annex_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_credit_support_annex_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_flow_conventions_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_flow_conventions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_index_convention_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_index_convention_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_recipe_composer_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_recipe_composer_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_get_recipe_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_get_recipe_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_holdings_adjustment_header.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_holdings_adjustment_header.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_i_unit_definition_dto.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_i_unit_definition_dto.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_instrument_cash_flow.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_instrument_cash_flow.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_instrument_event_holder.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_instrument_event_holder.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_instrument_id_type_descriptor.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_instrument_id_type_descriptor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_legal_entity.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_legal_entity.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_list_complex_market_data_with_meta_data_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_list_complex_market_data_with_meta_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_mapping.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_mapping.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_moved_order_to_different_block_response.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_moved_order_to_different_block_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_order.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_order.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_order_instruction.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_order_instruction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_package.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_package.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_participation.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_participation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_performance_return.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_performance_return.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_person.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_person.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_placement.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_placement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_portfolio.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_portfolio.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_portfolio_cash_flow.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_portfolio_cash_flow.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_portfolio_cash_ladder.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_portfolio_cash_ladder.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_portfolio_trade_ticket.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_portfolio_trade_ticket.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_processed_command.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_processed_command.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_property.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_property.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_property_definition.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_property_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_property_interval.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_property_interval.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_queryable_key.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_queryable_key.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_quote.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_quote.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_quote_access_metadata_rule.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_quote_access_metadata_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_reconciliation_break.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_reconciliation_break.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_relation.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_relation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_relationship.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_relationship.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_scope_definition.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_scope_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_side_definition.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_side_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_string.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_string.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_tax_rule_set.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_tax_rule_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_transaction.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_transaction_type.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_transaction_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/resource_list_of_value_type.py` & `lusid_sdk-2.1.98/lusid/models/resource_list_of_value_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/response_meta_data.py` & `lusid_sdk-2.1.98/lusid/models/response_meta_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_data_key_rule.py` & `lusid_sdk-2.1.98/lusid/models/result_data_key_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_data_schema.py` & `lusid_sdk-2.1.98/lusid/models/result_data_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_key_rule.py` & `lusid_sdk-2.1.98/lusid/models/result_key_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_key_rule_type.py` & `lusid_sdk-2.1.98/lusid/models/result_key_rule_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value.py` & `lusid_sdk-2.1.98/lusid/models/result_value.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value0_d.py` & `lusid_sdk-2.1.98/lusid/models/result_value0_d.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_bool.py` & `lusid_sdk-2.1.98/lusid/models/result_value_bool.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_currency.py` & `lusid_sdk-2.1.98/lusid/models/result_value_currency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_date_time_offset.py` & `lusid_sdk-2.1.98/lusid/models/result_value_date_time_offset.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_decimal.py` & `lusid_sdk-2.1.98/lusid/models/result_value_decimal.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_dictionary.py` & `lusid_sdk-2.1.98/lusid/models/result_value_dictionary.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_int.py` & `lusid_sdk-2.1.98/lusid/models/result_value_int.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_string.py` & `lusid_sdk-2.1.98/lusid/models/result_value_string.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/result_value_type.py` & `lusid_sdk-2.1.98/lusid/models/result_value_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/reverse_stock_split_event.py` & `lusid_sdk-2.1.98/lusid/models/reverse_stock_split_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/rounding_configuration.py` & `lusid_sdk-2.1.98/lusid/models/rounding_configuration.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/rounding_configuration_component.py` & `lusid_sdk-2.1.98/lusid/models/rounding_configuration_component.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/rounding_convention.py` & `lusid_sdk-2.1.98/lusid/models/rounding_convention.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/scaling_methodology.py` & `lusid_sdk-2.1.98/lusid/models/scaling_methodology.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/schedule.py` & `lusid_sdk-2.1.98/lusid/models/schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/schedule_type.py` & `lusid_sdk-2.1.98/lusid/models/schedule_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/scope_definition.py` & `lusid_sdk-2.1.98/lusid/models/scope_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/scrip_dividend_event.py` & `lusid_sdk-2.1.98/lusid/models/scrip_dividend_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/script_map_reference.py` & `lusid_sdk-2.1.98/lusid/models/script_map_reference.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/security_election.py` & `lusid_sdk-2.1.98/lusid/models/security_election.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/sequence_definition.py` & `lusid_sdk-2.1.98/lusid/models/sequence_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_legal_entity_identifiers_request.py` & `lusid_sdk-2.1.98/lusid/models/set_legal_entity_identifiers_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_legal_entity_properties_request.py` & `lusid_sdk-2.1.98/lusid/models/set_legal_entity_properties_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_person_identifiers_request.py` & `lusid_sdk-2.1.98/lusid/models/set_person_identifiers_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_person_properties_request.py` & `lusid_sdk-2.1.98/lusid/models/set_person_properties_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_share_class_instruments_request.py` & `lusid_sdk-2.1.98/lusid/models/set_share_class_instruments_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_transaction_configuration_alias.py` & `lusid_sdk-2.1.98/lusid/models/set_transaction_configuration_alias.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/set_transaction_configuration_source_request.py` & `lusid_sdk-2.1.98/lusid/models/set_transaction_configuration_source_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/side_configuration_data.py` & `lusid_sdk-2.1.98/lusid/models/side_configuration_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/side_configuration_data_request.py` & `lusid_sdk-2.1.98/lusid/models/side_configuration_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/side_definition.py` & `lusid_sdk-2.1.98/lusid/models/side_definition.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/side_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/side_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/sides_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/sides_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/simple_cash_flow_loan.py` & `lusid_sdk-2.1.98/lusid/models/simple_cash_flow_loan.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/simple_instrument.py` & `lusid_sdk-2.1.98/lusid/models/simple_instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/sort_order.py` & `lusid_sdk-2.1.98/lusid/models/sort_order.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modification.py` & `lusid_sdk-2.1.98/lusid/models/staged_modification.py`
...
### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modification_decision.py` & `lusid_sdk-2.1.98/lusid/models/staged_modification_decision.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modification_decision_request.py` & `lusid_sdk-2.1.98/lusid/models/staged_modification_decision_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modification_effective_range.py` & `lusid_sdk-2.1.98/lusid/models/staged_modification_effective_range.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modification_staging_rule.py` & `lusid_sdk-2.1.98/lusid/models/staged_modification_staging_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modifications_entity_hrefs.py` & `lusid_sdk-2.1.98/lusid/models/staged_modifications_entity_hrefs.py`
...
### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modifications_info.py` & `lusid_sdk-2.1.98/lusid/models/staged_modifications_info.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staged_modifications_requested_change_interval.py` & `lusid_sdk-2.1.98/lusid/models/staged_modifications_requested_change_interval.py`
...
### Comparing `lusid_sdk-2.1.97/lusid/models/staging_rule.py` & `lusid_sdk-2.1.98/lusid/models/staging_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staging_rule_approval_criteria.py` & `lusid_sdk-2.1.98/lusid/models/staging_rule_approval_criteria.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staging_rule_match_criteria.py` & `lusid_sdk-2.1.98/lusid/models/staging_rule_match_criteria.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/staging_rule_set.py` & `lusid_sdk-2.1.98/lusid/models/staging_rule_set.py`
...
### Comparing `lusid_sdk-2.1.97/lusid/models/step_schedule.py` & `lusid_sdk-2.1.98/lusid/models/step_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/stock_dividend_event.py` & `lusid_sdk-2.1.98/lusid/models/stock_dividend_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/stock_split_event.py` & `lusid_sdk-2.1.98/lusid/models/stock_split_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/stream.py` & `lusid_sdk-2.1.98/lusid/models/stream.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/string_comparison_type.py` & `lusid_sdk-2.1.98/lusid/models/string_comparison_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/string_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/string_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/string_list.py` & `lusid_sdk-2.1.98/lusid/models/string_list.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/string_list_compliance_parameter.py` & `lusid_sdk-2.1.98/lusid/models/string_list_compliance_parameter.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/structured_result_data.py` & `lusid_sdk-2.1.98/lusid/models/structured_result_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/structured_result_data_id.py` & `lusid_sdk-2.1.98/lusid/models/structured_result_data_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/sub_holding_key_value_equals.py` & `lusid_sdk-2.1.98/lusid/models/sub_holding_key_value_equals.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/target_tax_lot.py` & `lusid_sdk-2.1.98/lusid/models/target_tax_lot.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/target_tax_lot_request.py` & `lusid_sdk-2.1.98/lusid/models/target_tax_lot_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/tax_rule.py` & `lusid_sdk-2.1.98/lusid/models/tax_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/tax_rule_set.py` & `lusid_sdk-2.1.98/lusid/models/tax_rule_set.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/template_field.py` & `lusid_sdk-2.1.98/lusid/models/template_field.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/term_deposit.py` & `lusid_sdk-2.1.98/lusid/models/term_deposit.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/total_return_swap.py` & `lusid_sdk-2.1.98/lusid/models/total_return_swap.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/touch.py` & `lusid_sdk-2.1.98/lusid/models/touch.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/trade_ticket.py` & `lusid_sdk-2.1.98/lusid/models/trade_ticket.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/trade_ticket_type.py` & `lusid_sdk-2.1.98/lusid/models/trade_ticket_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction.py` & `lusid_sdk-2.1.98/lusid/models/transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_configuration_data.py` & `lusid_sdk-2.1.98/lusid/models/transaction_configuration_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_configuration_data_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_configuration_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_configuration_movement_data.py` & `lusid_sdk-2.1.98/lusid/models/transaction_configuration_movement_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_configuration_movement_data_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_configuration_movement_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_configuration_type_alias.py` & `lusid_sdk-2.1.98/lusid/models/transaction_configuration_type_alias.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_currency_and_amount.py` & `lusid_sdk-2.1.98/lusid/models/transaction_currency_and_amount.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_field_map.py` & `lusid_sdk-2.1.98/lusid/models/transaction_field_map.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_price.py` & `lusid_sdk-2.1.98/lusid/models/transaction_price.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_price_and_type.py` & `lusid_sdk-2.1.98/lusid/models/transaction_price_and_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_price_type.py` & `lusid_sdk-2.1.98/lusid/models/transaction_price_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_property_map.py` & `lusid_sdk-2.1.98/lusid/models/transaction_property_map.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_property_mapping.py` & `lusid_sdk-2.1.98/lusid/models/transaction_property_mapping.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_property_mapping_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_property_mapping_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_query_mode.py` & `lusid_sdk-2.1.98/lusid/models/transaction_query_mode.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_query_parameters.py` & `lusid_sdk-2.1.98/lusid/models/transaction_query_parameters.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_reconciliation_request_v2.py` & `lusid_sdk-2.1.98/lusid/models/transaction_reconciliation_request_v2.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_roles.py` & `lusid_sdk-2.1.98/lusid/models/transaction_roles.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_set_configuration_data.py` & `lusid_sdk-2.1.98/lusid/models/transaction_set_configuration_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_set_configuration_data_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_set_configuration_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_status.py` & `lusid_sdk-2.1.98/lusid/models/transaction_status.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_template.py` & `lusid_sdk-2.1.98/lusid/models/transaction_template.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_template_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_template_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_template_specification.py` & `lusid_sdk-2.1.98/lusid/models/transaction_template_specification.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_type.py` & `lusid_sdk-2.1.98/lusid/models/transaction_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_type_alias.py` & `lusid_sdk-2.1.98/lusid/models/transaction_type_alias.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_type_calculation.py` & `lusid_sdk-2.1.98/lusid/models/transaction_type_calculation.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_type_movement.py` & `lusid_sdk-2.1.98/lusid/models/transaction_type_movement.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_type_property_mapping.py` & `lusid_sdk-2.1.98/lusid/models/transaction_type_property_mapping.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transaction_type_request.py` & `lusid_sdk-2.1.98/lusid/models/transaction_type_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transactions_reconciliations_response.py` & `lusid_sdk-2.1.98/lusid/models/transactions_reconciliations_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/transition_event.py` & `lusid_sdk-2.1.98/lusid/models/transition_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_entities_inlined_request.py` & `lusid_sdk-2.1.98/lusid/models/translate_entities_inlined_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_entities_request.py` & `lusid_sdk-2.1.98/lusid/models/translate_entities_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_entities_response.py` & `lusid_sdk-2.1.98/lusid/models/translate_entities_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_instrument_definitions_request.py` & `lusid_sdk-2.1.98/lusid/models/translate_instrument_definitions_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_instrument_definitions_response.py` & `lusid_sdk-2.1.98/lusid/models/translate_instrument_definitions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_trade_ticket_request.py` & `lusid_sdk-2.1.98/lusid/models/translate_trade_ticket_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translate_trade_tickets_response.py` & `lusid_sdk-2.1.98/lusid/models/translate_trade_tickets_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translation_context.py` & `lusid_sdk-2.1.98/lusid/models/translation_context.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translation_input.py` & `lusid_sdk-2.1.98/lusid/models/translation_input.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translation_result.py` & `lusid_sdk-2.1.98/lusid/models/translation_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translation_script.py` & `lusid_sdk-2.1.98/lusid/models/translation_script.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/translation_script_id.py` & `lusid_sdk-2.1.98/lusid/models/translation_script_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/trial_balance.py` & `lusid_sdk-2.1.98/lusid/models/trial_balance.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/trial_balance_query_parameters.py` & `lusid_sdk-2.1.98/lusid/models/trial_balance_query_parameters.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/trigger_event.py` & `lusid_sdk-2.1.98/lusid/models/trigger_event.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/typed_resource_id.py` & `lusid_sdk-2.1.98/lusid/models/typed_resource_id.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/unit_schema.py` & `lusid_sdk-2.1.98/lusid/models/unit_schema.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/units_ratio.py` & `lusid_sdk-2.1.98/lusid/models/units_ratio.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/unmatched_holding_method.py` & `lusid_sdk-2.1.98/lusid/models/unmatched_holding_method.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_amortisation_rule_set_details_request.py` & `lusid_sdk-2.1.98/lusid/models/update_amortisation_rule_set_details_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_calendar_request.py` & `lusid_sdk-2.1.98/lusid/models/update_calendar_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_custom_entity_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/update_custom_entity_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_custom_entity_type_request.py` & `lusid_sdk-2.1.98/lusid/models/update_custom_entity_type_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_cut_label_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/update_cut_label_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_data_type_request.py` & `lusid_sdk-2.1.98/lusid/models/update_data_type_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_derived_property_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/update_derived_property_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_instrument_identifier_request.py` & `lusid_sdk-2.1.98/lusid/models/update_instrument_identifier_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_portfolio_group_request.py` & `lusid_sdk-2.1.98/lusid/models/update_portfolio_group_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_portfolio_request.py` & `lusid_sdk-2.1.98/lusid/models/update_portfolio_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_property_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/update_property_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/update_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_relationship_definition_request.py` & `lusid_sdk-2.1.98/lusid/models/update_relationship_definition_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_staging_rule_set_request.py` & `lusid_sdk-2.1.98/lusid/models/update_staging_rule_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_tax_rule_set_request.py` & `lusid_sdk-2.1.98/lusid/models/update_tax_rule_set_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/update_unit_request.py` & `lusid_sdk-2.1.98/lusid/models/update_unit_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_cds_flow_conventions_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_cds_flow_conventions_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_complex_market_data_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_complex_market_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_compliance_rule_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_compliance_rule_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_compliance_run_summary_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_compliance_run_summary_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_compliance_run_summary_result.py` & `lusid_sdk-2.1.98/lusid/models/upsert_compliance_run_summary_result.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_corporate_action_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_corporate_action_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_corporate_actions_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_corporate_actions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_counterparty_agreement_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_counterparty_agreement_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_credit_support_annex_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_credit_support_annex_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_custom_entities_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_custom_entities_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_custom_entity_access_metadata_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_custom_entity_access_metadata_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_dialect_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_dialect_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_flow_conventions_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_flow_conventions_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_index_convention_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_index_convention_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_instrument_event_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_instrument_event_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_instrument_events_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_instrument_events_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_instrument_properties_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_instrument_properties_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_instrument_property_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_instrument_property_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_instruments_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_instruments_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_legal_entities_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_legal_entities_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_legal_entity_access_metadata_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_legal_entity_access_metadata_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_legal_entity_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_legal_entity_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_person_access_metadata_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_person_access_metadata_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_person_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_person_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_portfolio_access_metadata_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_portfolio_access_metadata_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_portfolio_group_access_metadata_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_portfolio_group_access_metadata_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_portfolio_transactions_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_portfolio_transactions_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_quote_access_metadata_rule_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_quote_access_metadata_rule_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_quote_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_quote_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_quotes_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_quotes_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_recipe_composer_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_recipe_composer_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_recipe_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_recipe_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_reference_portfolio_constituents_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_reference_portfolio_constituents_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_reference_portfolio_constituents_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_reference_portfolio_constituents_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_result_values_data_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_result_values_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_returns_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_returns_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_single_structured_data_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_single_structured_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_structured_data_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_structured_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_structured_result_data_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_structured_result_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_transaction_properties_response.py` & `lusid_sdk-2.1.98/lusid/models/upsert_transaction_properties_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_translation_script_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_translation_script_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/upsert_valuation_point_request.py` & `lusid_sdk-2.1.98/lusid/models/upsert_valuation_point_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/user.py` & `lusid_sdk-2.1.98/lusid/models/user.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/valuation_point_data_query_parameters.py` & `lusid_sdk-2.1.98/lusid/models/valuation_point_data_query_parameters.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/valuation_point_data_request.py` & `lusid_sdk-2.1.98/lusid/models/valuation_point_data_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/valuation_point_data_response.py` & `lusid_sdk-2.1.98/lusid/models/valuation_point_data_response.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/valuation_request.py` & `lusid_sdk-2.1.98/lusid/models/valuation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/valuation_schedule.py` & `lusid_sdk-2.1.98/lusid/models/valuation_schedule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/valuations_reconciliation_request.py` & `lusid_sdk-2.1.98/lusid/models/valuations_reconciliation_request.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/value_type.py` & `lusid_sdk-2.1.98/lusid/models/value_type.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/vendor_dependency.py` & `lusid_sdk-2.1.98/lusid/models/vendor_dependency.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/vendor_library.py` & `lusid_sdk-2.1.98/lusid/models/vendor_library.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/vendor_model_rule.py` & `lusid_sdk-2.1.98/lusid/models/vendor_model_rule.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/version.py` & `lusid_sdk-2.1.98/lusid/models/version.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/version_summary_dto.py` & `lusid_sdk-2.1.98/lusid/models/version_summary_dto.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_a2_b_data_record.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_a2_b_data_record.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_a2_b_movement_record.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_a2_b_movement_record.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_holding_contributor.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_holding_contributor.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_journal_entry_line.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_journal_entry_line.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_output_transaction.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_output_transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_portfolio_holding.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_portfolio_holding.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_transaction.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_transaction.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_of_trial_balance.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_of_trial_balance.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/versioned_resource_list_with_warnings_of_portfolio_holding.py` & `lusid_sdk-2.1.98/lusid/models/versioned_resource_list_with_warnings_of_portfolio_holding.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/virtual_document.py` & `lusid_sdk-2.1.98/lusid/models/virtual_document.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/virtual_document_row.py` & `lusid_sdk-2.1.98/lusid/models/virtual_document_row.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/virtual_row.py` & `lusid_sdk-2.1.98/lusid/models/virtual_row.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/warning.py` & `lusid_sdk-2.1.98/lusid/models/warning.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/weekend_mask.py` & `lusid_sdk-2.1.98/lusid/models/weekend_mask.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/weighted_instrument.py` & `lusid_sdk-2.1.98/lusid/models/weighted_instrument.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/weighted_instrument_in_line_lookup_identifiers.py` & `lusid_sdk-2.1.98/lusid/models/weighted_instrument_in_line_lookup_identifiers.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/weighted_instruments.py` & `lusid_sdk-2.1.98/lusid/models/weighted_instruments.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/models/yield_curve_data.py` & `lusid_sdk-2.1.98/lusid/models/yield_curve_data.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/lusid/rest.py` & `lusid_sdk-2.1.98/lusid/rest.py`

 * *Files identical despite different names*

### Comparing `lusid_sdk-2.1.97/pyproject.toml` & `lusid_sdk-2.1.98/pyproject.toml`
...
### Comparing `lusid_sdk-2.1.97/PKG-INFO` & `lusid_sdk-2.1.98/PKG-INFO`
