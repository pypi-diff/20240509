# Comparing `tmp/pretext-2.4.1.dev20240507.tar.gz` & `tmp/pretext-2.4.1.dev20240509.tar.gz`
...
## Comparing `pretext-2.4.1.dev20240507.tar` & `pretext-2.4.1.dev20240509.tar`
...
### Comparing `pretext-2.4.1.dev20240507/LICENSE` & `pretext-2.4.1.dev20240509/LICENSE`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/README.md` & `pretext-2.4.1.dev20240509/README.md`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/__init__.py` & `pretext-2.4.1.dev20240509/pretext/__init__.py`
...
### Comparing `pretext-2.4.1.dev20240507/pretext/cli.py` & `pretext-2.4.1.dev20240509/pretext/cli.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/codechat.py` & `pretext-2.4.1.dev20240509/pretext/codechat.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/constants.py` & `pretext-2.4.1.dev20240509/pretext/constants.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/core/__init__.py` & `pretext-2.4.1.dev20240509/pretext/core/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/core/pretext.py` & `pretext-2.4.1.dev20240509/pretext/core/pretext.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/core/resources.py` & `pretext-2.4.1.dev20240509/pretext/core/resources.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/core/resources.zip` & `pretext-2.4.1.dev20240509/pretext/core/resources.zip`
...
-    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/0.99.6/jsxgraphcore.js"/>
+    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/1.8.0/jsxgraph.css"/>
+    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jsxgraph/1.8.0/jsxgraphcore.js"/>
   </xsl:template>
...
-    possibletocentries[0].scrollIntoView({
-        block: "center"
-    });
...
### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/Crossref.jinja2s` & `pretext-2.4.1.dev20240509/pretext/plastex/Crossref.jinja2s`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/FontSelection.jinja2s` & `pretext-2.4.1.dev20240509/pretext/plastex/FontSelection.jinja2s`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/Sectioning.jinja2s` & `pretext-2.4.1.dev20240509/pretext/plastex/Sectioning.jinja2s`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/Themes/default/document-layout.jinja2` & `pretext-2.4.1.dev20240509/pretext/plastex/Themes/default/document-layout.jinja2`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/__init__.py` & `pretext-2.4.1.dev20240509/pretext/plastex/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/hyperref.jinja2s` & `pretext-2.4.1.dev20240509/pretext/plastex/hyperref.jinja2s`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/plastex/subfig.jinja2s` & `pretext-2.4.1.dev20240509/pretext/plastex/subfig.jinja2s`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/project/__init__.py` & `pretext-2.4.1.dev20240509/pretext/project/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/project/xml.py` & `pretext-2.4.1.dev20240509/pretext/project/xml.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/templates/__init__.py` & `pretext-2.4.1.dev20240509/pretext/templates/__init__.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/.devcontainer.json` & `pretext-2.4.1.dev20240509/pretext/templates/resources/.devcontainer.json`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/.gitignore` & `pretext-2.4.1.dev20240509/pretext/templates/resources/.gitignore`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/article.zip` & `pretext-2.4.1.dev20240509/pretext/templates/resources/article.zip`
...
### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/book.zip` & `pretext-2.4.1.dev20240509/pretext/templates/resources/book.zip`
...
### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/codechat_config.yaml` & `pretext-2.4.1.dev20240509/pretext/templates/resources/codechat_config.yaml`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/demo.zip` & `pretext-2.4.1.dev20240509/pretext/templates/resources/demo.zip`
...
### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/deploy.yml` & `pretext-2.4.1.dev20240509/pretext/templates/resources/deploy.yml`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/hello.zip` & `pretext-2.4.1.dev20240509/pretext/templates/resources/hello.zip`
...
### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/slideshow.zip` & `pretext-2.4.1.dev20240509/pretext/templates/resources/slideshow.zip`
...
### Comparing `pretext-2.4.1.dev20240507/pretext/templates/resources/test-build.yml` & `pretext-2.4.1.dev20240509/pretext/templates/resources/test-build.yml`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pretext/utils.py` & `pretext-2.4.1.dev20240509/pretext/utils.py`

 * *Files identical despite different names*

### Comparing `pretext-2.4.1.dev20240507/pyproject.toml` & `pretext-2.4.1.dev20240509/pyproject.toml`
...
### Comparing `pretext-2.4.1.dev20240507/PKG-INFO` & `pretext-2.4.1.dev20240509/PKG-INFO`
